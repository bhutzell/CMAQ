...
**Description**:   
The pull request accomplishes two items by changes to the CHEMMECH utility.     
...
|:------:|:-------:|
| [Merge for PR#1211](https://github.com/USEPA/CMAQ/commit/19f07ebd67978a54709b4859607196b0eb65bb4c) | [PR#1361](https://github.com/USEPA/CMAQ_Dev/pull/1211)  | 
...
**Description**:   
Updates remove typographic errors in CHEMMECH output files documenting a chemical mechanism such as the markdown files found under the repository's _**CCTM/src/MECHS/mechanism_information**_ directory.  
...
**Significance and Impact**:   
None, but allows to more efficiently use the CMAQ repository on Windows and Macintosh operating systems.  
...
**Significance and Impact**:   
None, but allows to more efficiently use the CMAQ repository.
...
**Release Version/Date**: CMAQ Version 5.4       
**Description**:   
The CHEMMECH utility was updated to accomplish the below items.
...
**Significance and Impact**:    
(1) Allows users to run the F0AM box-model when creating a CMAQ mechanism via the chemmech utility. (2) Adds to chemmech a run-time option revising the input mechanism definitions file for how each reaction changes the balance of elements such as carbon, nitrogen, and sulfur.            
