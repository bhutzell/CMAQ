...
The CMAQv6.0 alpha 108 km simulation used the CRACMM3M chemical mechanism that includes a detailed representation of halogen chemistry while the 36 km and 12 km simulations used the CRACMM3 chemical mechanism that includes a revised condensed representation of halogen chemistry. Both the CMAQv6.0 alpha CRACMM3M and CRACMM3 chemical mechanisms include photolysis of aerosol nitrate as described for hemispheric applications in [Sarwar et al. (2024)](https://doi.org/10.1016/j.scitotenv.2024.170406) and CONUS applications in [Sarwar et al. (2025)](https://doi.org/10.1016/j.scitotenv.2025.178968).

### Ozone
* v6.0 alpha vs. v5.5 hemispheric comparisons: ozone mixing ratios generally show substantial increases in v6.0 throughout most of the northern hemisphere and throughout the year, with the largest increases of 5 – 15 ppbV occuring during springtime. These increases occur throughout the troposphere. While there are many differences between the CB6R5M_AE7_AQ chemical mechanism used for the CMAQv5.5 simulations and the CRACMM3M chemical mechanism used for the CMAQv6.0 alpha simulations, the primary driver of these ozone increases is the addition of aerosol nitrate photolysis in CRACMM3M. The magnitude and spatial and seasonal patterns of the increase is consistent with [Sarwar et al. (2024)](https://doi.org/10.1016/j.scitotenv.2024.170406).
* v6.0 alpha vs. v5.5 CONUS comparisons: consistent with the hemispheric simulations providing boundary conditions, ozone mixing ratios over the CONUS also show substantial increases in v6.0 alpha, with the largest increases of 10 – 13 ppbV occuring during springtime over parts of the intermountain West. A v6.0 alpha CONUS sensitivity simulation utilizing the CRACMM2 mechanism (which does not include the aerosol nitrate photolysis effect) instead of the CRACMM3 mechanism confirmed that the majority of this increase (75% or more) is caused by higher ozone from the boundary conditions. This is consistent with the results reported in [Sarwar et al. (2025)](https://doi.org/10.1016/j.scitotenv.2025.178968) who also reported that the majority of the impacts of aerosol nitrate photolysis on CONUS simulations is through its effect on large-scale tropospheric ozone.

### PM2.5
* Both the hemispheric and CONUS simulations show decreases in PM2.5 due to the reductions of windblown dust emissions caused by including the effects of non-photosynthetic vegetation (or brown vegetation) on these emissions in v6.0 alpha. The CONUS simulations show a further decrease in these emissions due to a code correction when using the windblown dust option with meteorological fields configured with NLCD40 land use, the option used in our CONUS simulations.
