...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE mchem_Util, ONLY : Integrator_Update_Options
...
! All compiled assembly code was verified just short of linking to a proper BLAS.
   ...
   USE mchem_Global,  ONLY : cNONZERO, rNVAR
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE mchem_Parameters, ONLY : NVAR, LU_NONZERO
 USE mchem_Global,     ONLY : FIX, RCONST, TIME
 USE mchem_Function,   ONLY : Fun, Fun_SPLIT
 USE mchem_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE mchem_Parameters, ONLY: NVAR, LU_NONZERO
 USE mchem_Global, ONLY: FIX, RCONST, TIME
 USE mchem_Function, ONLY: Fun_SPLITF
!~~~> Input variables
   REAL(kind=dp) :: T, Y(NVAR)
!~~~> Output variables
   REAL(kind=dp) :: Ydot(NVAR)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE mchem_Parameters,    ONLY : NVAR, LU_NONZERO
 USE mchem_Global,        ONLY : FIX, RCONST, TIME
 USE mchem_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE mchem_LinearAlgebra
 USE mchem_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
