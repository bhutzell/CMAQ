...
!           Aqueous diffusion limitation for O3
            ...
            IF( QY .GE. 1 ) THEN    
               ...
               IF(kO3T .LT. 0.d0) THEN
                  q1 = 0.d0
               ELSE
                  q1 = DDIAM / 2.0D0 * SQRT( kO3T / DAQ )  ! diffuso-reactive pa
              END IF    
...
REAL( kind=dp )FUNCTION KIEPOX ( KH, KHSO4 )

            IMPLICIT NONE
      
            REAL( kind=dp ) KH, KHSO4
            REAL( kind=dp ) K1, K2
            REAL( kind=dp ) KIEPOXT
...
!
            ...
            Q = 1.0D0
               ...
               KIEPOXT = KIEPOXT + (K1 + K2) * VAR( ind_L_NO3MIN ) * PHI2    ! I

               IF(KIEPOXT .LT. 0.d0) THEN
                  q1 = 0.d0
               ELSE
                  q1 = DDIAM/2.0D0 * SQRT( KIEPOXT / DAQ )  ! diffuso-reactive p
               END IF
...
! End INLINED RCONST
  ...
  RCONST(143) = ((KIEPOX(9.0D-4,1.31D-5)))
  RCONST(144) = ((KIEPOX(8.83D-3,2.92D-6)))
  RCONST(155) = ((DISF(3.47D-4,-2.67D+2,2.D+10,0)))
  RCONST(156) = ((DISF(5.6D-2,-4.53D+2,5.D+10,0)))
  RCONST(157) = ((DISF(5.42D-5,-8.05D+2,5.D+10,1)))
  RCONST(158) = ((DISF(3.2D-3,0.d0,2.D+10,0)))
  RCONST(159) = ((DISF(1.48D-4,-8.05D+1,2.D+10,0)))
  RCONST(160) = ((DISF(1.75D-5,4.6D+1,5.D+10,0)))
  RCONST(161) = ((DISB(2.D10,2)))
  RCONST(162) = ((DISB(5.D10,2)))
  RCONST(163) = ((DISB(5.D10,1)))
  RCONST(164) = ((DISB(2.D10,2)))
  RCONST(165) = ((DISB(2.D10,2)))
  RCONST(166) = ((DISB(5.D10,2)))
  RCONST(172) = ((KRXN(5.0D+8,0.D0,0,0,0)))
  RCONST(173) = ((KRXN(1.0D+9,0.D0,0,0,0)))
  RCONST(174) = ((KRXN(6.0D+8,0.D0,0,0,0)))
  RCONST(175) = ((KRXN(8.6D+8,0.D0,0,0,0)))
  RCONST(176) = ((KRXN(1.1D+9,-1516.D0,0,0,0)))
  RCONST(177) = ((KRXN(3.62D+8,0.D0,0,0,0)))
  RCONST(178) = ((KRXN(2.9D+9,0.D0,0,0,0)))
  RCONST(179) = ((KRXN(1.4D+6,0.D0,0,0,0)))
  RCONST(180) = ((KRXN(4.7D+7,0.D0,0,0,0)))
  RCONST(181) = ((KRXN(7.7D+6,0.D0,0,0,0)))
  RCONST(182) = ((KRXN(7.0D+8,0.D0,0,0,0)))
  RCONST(183) = ((KRXN(6.0D+7,0.D0,0,0,0)))
  RCONST(184) = ((KRXN(6.0D+7,0.D0,0,0,0)))
  RCONST(185) = ((KRXN(1.6D+7,0.D0,0,0,0)))
  RCONST(186) = ((KRXN(8.5D+7,0.D0,0,0,0)))
  RCONST(187) = ((KRXN(1.1D+9,-1020.D0,0,0,0)))
  RCONST(188) = ((KRXN(1.2D+8,-990.D0,0,0,0)))
  RCONST(189) = ((KRXN(1.1D+9,-1020.D0,0,0,0)))
  RCONST(211) = ((KRXN(3.6D+9,-930.D0,0,0,0)))
  RCONST(212) = ((KRXN(2.8D+10,0.D0,0,0,0)))
  RCONST(213) = ((KRXN(3.5D+10,-720.D0,0,0,0)))
  RCONST(214) = ((KRXN(3.2D+7,-1700.D0,0,0,0)))
  RCONST(215) = ((KRXN(2.7D+9,0.D0,0,0,0)))
  RCONST(216) = ((KRXN(1.8D+9,0.D0,0,0,0)))
  RCONST(217) = ((KRXN(4.5D+9,0.D0,0,0,0)))
  RCONST(218) = ((KRXN(2.6D-2,0.D0,4,0,0)))
  RCONST(219) = ((KRXN(1.0D+5,0.D0,0,0,0)))
  RCONST(220) = ((KRXN(1.3D+9,-2200.D0,0,0,0)))
  RCONST(221) = ((KRXN(1.1D+9,0.D0,0,0,0)))
  RCONST(222) = ((KRXN(1.7D+9,0.D0,0,0,0)))
  RCONST(223) = ((KRXN(2.2D+8,-2600.D0,0,0,0)))
  RCONST(224) = ((KRXN(7.1D+6,0.D0,3,0,0)))
  RCONST(225) = ((KRXN(4.6D+2,-1100.D0,0,0,0)))
  RCONST(226) = ((KRXN(1.7D+8,-2200.D0,0,0,0)))
  RCONST(227) = ((KRXN(5.0D+5,0.D0,0,0,0)))
  RCONST(228) = ((KRXN(3.4D+9,-1200.D0,0,0,0)))
  RCONST(229) = ((KRXN(7.9D+2,-2900.D0,0,0,0)))
  RCONST(230) = ((KRXN(2.5D+7,-2450.D0,0,0,0)))
  RCONST(231) = ((KRXN(1.2D-7,0.D0,4,0,0)))
  RCONST(232) = ((KRXN(3.7D3,0.D0,0,0,0)))
  RCONST(233) = ((KRXN(3.0D8,0.D0,0,0,0)))
  RCONST(234) = ((KRXN(7.9D+2,-2900.D0,0,0,0)))
  RCONST(235) = ((KRXN(2.5D+7,-2450.D0,0,0,0)))
  RCONST(236) = ((KRXN(1.2D-7,0.D0,4,0,0)))
  RCONST(237) = ((KRXN(3.7D3,0.D0,0,0,0)))
  RCONST(238) = ((KRXN(3.0D8,0.D0,0,0,0)))
