...
'OP3'; 'PAA'; 'ONIT'; 'PAN'; 'N2O5'; ...
'SO2'; 'SULF'; 'SULRXN'; 'ETH'; 'HC3'; ...
'HC3P'; 'ASOATJ'; 'HC5'; 'HC5P'; 'ETE'; ...
'ETEP'; 'OLT'; 'OLTP'; 'OLI'; 'OLIP'; ...
'ACE'; 'ORA1'; 'BEN'; 'BENP'; 'PHEN'; ...
'TOL'; 'TOLP'; 'CSL'; 'XYM'; 'XYMP'; ...
'XYE'; 'XYEP'; 'ISO'; 'ISOP'; 'API'; ...
'APIP1'; 'APIP2'; 'LIM'; 'LIMP1'; 'LIMP2'; ...
'PINALP'; 'RCO3'; 'LIMALP'; 'ACTP'; 'MEKP'; ...
'KETP'; 'MCP'; 'MVKP'; 'UALP'; 'DCB3'; ...
'BALP'; 'ADDC'; 'MCT'; 'MCTO'; 'MOH'; ...
'EOH'; 'ROH'; 'ETEG'; 'ISHP'; 'IEPOX'; ...
'MAHP'; 'ORA2'; 'ORAP'; 'PPN'; 'MPAN'; ...
'TRPN'; 'HOM'; 'NALD'; 'ISON'; 'MCTP'; ...
'OLNN'; 'OLND'; 'APINP1'; 'APINP2'; 'LIMNP1'; ...
'LIMNP2'; 'ADCN'; 'VROCP4OXY2'; 'VROCN1OXY6'; 'FURANONE'; ...
'VROCP3OXY2'; 'VROCP0OXY4'; 'BAL1'; 'BAL2'; 'ELHOM'; ...
...
%  57, <R052>
i=i+1;
Rnames{  57} = 'NO + NO + O2 = 2.00000*NO2 ';
...
%  64, <R059>
i=i+1;
Rnames{  64} = 'NO3 + HO2 = 0.70000*HO +  0.70000*NO2 +  0.30000*HNO3 ';
k(:,i) = (  3.5000E-12 ); 
...
%  69, <R064>
i=i+1;
Rnames{  69} = 'N2O5 = NO2 + NO3 ';
k(:,i) = (  1.7241E+26.*exp( -1.0840E+04./T).*k(:,  68) ); 
Gstr{i,   1}='N2O5';
fN2O5(i)=fN2O5(i)-1.0;
...
%  70, <R065>
i=i+1;
Rnames{  70} = 'N2O5 + H2O = 2.00000*HNO3 ';
k(:,i) = (  1.0000E-22 ).*H2O; 
Gstr{i,   1}='N2O5';
fN2O5(i)=fN2O5(i)-1.0;
...
%  72, <R067>
i=i+1;
Rnames{  72} = 'HNO4 = HO2 + NO2 ';
k(:,i) = (  4.7619E+26.*exp( -1.0900E+04./T).*k(:,  71) ); 
Gstr{i,   1}='HNO4';
fHNO4(i)=fHNO4(i)-1.0;
fHO2(i)=fHO2(i)+  1.000;fNO2(i)=fNO2(i)+  1.000;
...
%  74, <R069>
i=i+1;
Rnames{  74} = 'SO2 + HO = HO2 + SULF + SULRXN ';
...
%  78, <R073>
i=i+1;
Rnames{  78} = 'HC3 + HO = HC3P +  0.00003*ASOATJ ';
...
%  79, <R074>
i=i+1;
Rnames{  79} = 'HC5 + HO = HC5P +  0.00134*ASOATJ ';
...
%  83, <R080>
i=i+1;
Rnames{  83} = 'ACE + HO = 0.65000*HO +  0.35000*HO2 +  0.35000*CO +  0.65000*GLY +  0.35000*ORA1 ';
...
%  84, <ROCARO31>
i=i+1;
Rnames{  84} = 'BEN + HO = 0.47000*BENP +  0.53000*PHEN +  0.53000*HO2 ';
...
%  85, <ROCARO41>
i=i+1;
Rnames{  85} = 'TOL + HO = 0.82000*TOLP +  0.18000*CSL +  0.18000*HO2 ';
...
%  86, <ROCARO51>
i=i+1;
Rnames{  86} = 'XYM + HO = 0.83000*XYMP +  0.17000*CSL +  0.17000*HO2 ';
k(:,i) = (  2.3300E-11 ); 
...
%  87, <ROCARO61>
i=i+1;
Rnames{  87} = 'XYE + HO = 0.82000*XYEP +  0.18000*CSL +  0.18000*HO2 ';
k(:,i) = (  7.1600E-12 ); 
...
%  89, <R087>
i=i+1;
Rnames{  89} = 'API + HO = 0.97500*APIP1 +  0.02500*APIP2 ';
...
%  90, <R088>
i=i+1;
Rnames{  90} = 'LIM + HO = 0.94500*LIMP1 +  0.05500*LIMP2 ';
...
%  91, <TRP04>
i=i+1;
Rnames{  91} = 'PINAL + HO = 0.23000*PINALP +  0.77000*RCO3 ';
...
%  92, <TRP05>
i=i+1;
Rnames{  92} = 'LIMAL + HO = 0.70000*LIMALP +  0.30000*RCO3 ';
k(:,i) = (  1.0000E-10 ); 
...
% 100, <R096>
i=i+1;
Rnames{ 100} = 'MACR + HO = 0.57000*MACP +  0.43000*MCP ';
...
% 102, <R098>
i=i+1;
Rnames{ 102} = 'UALD + HO = 0.31300*ACO3 +  0.68700*UALP ';
...
% 103, <R099>
i=i+1;
Rnames{ 103} = 'GLY + HO = HO2 +  2.00000*CO ';
k(:,i) = (  1.1000E-11 ); 
...
% 105, <R101>
i=i+1;
Rnames{ 105} = 'DCB1 + HO = 0.52000*HO2 +  0.33000*CO +  0.40000*ALD +  0.78000*KET +  0.10000*GLY +  0.01000*MGLY ';
...
% 106, <R102>
i=i+1;
Rnames{ 106} = 'DCB2 + HO = 0.52000*HO2 +  0.33000*CO +  0.13000*MEK +  0.10000*GLY +  0.01000*MGLY +  0.78000*OP2 ';
k(:,i) = (  2.8000E-11.*exp(  1.7500E+02./T) ); 
...
% 107, <R103>
i=i+1;
Rnames{ 107} = 'DCB3 + HO = 0.56000*HO2 +  0.21000*MACP +  0.11000*CO +  0.27000*GLY +  0.01000*MGLY +  0.79000*OP2 ';
k(:,i) = (  1.0000E-11 ); 
...
% 109, <R105>
i=i+1;
Rnames{ 109} = 'PHEN + HO = 0.15200*ASOATJ +  0.61900*HO2 +  0.17000*ADDC +  0.05900*CHO +  0.61900*MCT ';
...
% 110, <R106>
i=i+1;
Rnames{ 110} = 'CSL + HO = 0.20000*ASOATJ +  0.58400*HO2 +  0.16000*ADDC +  0.05600*CHO +  0.58400*MCT ';
...
% 114, <R111>
i=i+1;
Rnames{ 114} = 'ROH + HO = HO2 +  0.71900*ALD +  0.18400*ACD ';
...
% 116, <R113>
i=i+1;
Rnames{ 116} = 'OP1 + HO = 0.35000*HO +  0.65000*MO2 +  0.35000*HCHO ';
...
% 117, <R114>
i=i+1;
Rnames{ 117} = 'OP2 + HO = 0.01000*HO +  0.44000*HC3P +  0.07000*XO2 +  0.08000*ALD +  0.41000*KET ';
...
% 118, <TRP06>
i=i+1;
Rnames{ 118} = 'OPB + HO = 0.01000*HO +  0.44000*HC10P +  0.07000*XO2 +  0.08000*ALD +  0.41000*KET ';
k(:,i) = (  3.4000E-12.*exp(  1.9000E+02./T) ); 
...
% 119, <R114a>
i=i+1;
Rnames{ 119} = 'OP3 + HO = 0.01000*HO +  0.44000*HC10P +  0.07000*XO2 +  0.08000*ALD +  0.41000*KET ';
k(:,i) = (  3.4000E-12.*exp(  1.9000E+02./T) ); 
...
% 120, <R115>
i=i+1;
Rnames{ 120} = 'ISHP + HO = HO + MACR +  0.90400*IEPOX ';
k(:,i) = (  1.0000E-10 ); 
...
% 123, <R118>
i=i+1;
Rnames{ 123} = 'ORA2 + HO = 0.64000*MO2 +  0.36000*ORAP ';
...
% 124, <R119>
i=i+1;
Rnames{ 124} = 'PAA + HO = 0.35000*HO +  0.65000*ACO3 +  0.35000*XO2 +  0.35000*HCHO ';
...
% 125, <R120>
i=i+1;
Rnames{ 125} = 'PAN + HO = XO2 + NO3 + HCHO ';
k(:,i) = (  4.0000E-14 ); 
...
% 126, <R121>
i=i+1;
Rnames{ 126} = 'PPN + HO = XO2 + NO3 + HCHO ';
k(:,i) = (  4.0000E-14 ); 
...
% 130, <R124>
i=i+1;
Rnames{ 130} = 'NALD + HO = NO2 + XO2 + HKET ';
...
% 131, <R125>
i=i+1;
Rnames{ 131} = 'ISON + HO = NALD +  0.07000*HKET +  0.07000*HCHO ';
k(:,i) = (  1.3000E-11 ); 
...
% 132, <R126>
i=i+1;
Rnames{ 132} = 'ETE + O3 = 0.08000*HO +  0.15000*HO2 +  0.43000*CO + HCHO +  0.37000*ORA1 ';
...
% 133, <R127>
i=i+1;
Rnames{ 133} = 'OLT + O3 = 0.22000*HO +  0.32000*HO2 +  0.08000*MO2 +  0.06000*ETHP +  0.04000*HC3P +  0.02000*HC5P +  0.06800*H2O2 +  0.43000*CO +  0.02000*ETH +  0.01500*HC3 +  0.00600*HC5 +  0.03200*BEN +  0.56000*HCHO +  0.01000*ACD +  0.44000*ALD +  0.03000*ACT +  0.02000*BALD +  0.06000*MEK +  0.01000*HKET +  0.03000*ORA1 +  0.06000*ORA2 ';
...
% 134, <R128>
i=i+1;
Rnames{ 134} = 'OLI + O3 = 0.46000*HO +  0.07000*HO2 +  0.32000*MO2 +  0.07000*ETHP +  0.04000*HC3P +  0.09000*ACO3 +  0.37000*CO +  0.02600*H2O2 +  0.01000*ETH +  0.01000*HC3 +  0.09000*HCHO +  0.45700*ACD +  0.73000*ALD +  0.11000*ACT +  0.01700*KET +  0.04400*HKET +  0.01700*ORA2 ';
...
% 135, <R130>
i=i+1;
Rnames{ 135} = 'ISO + O3 = 0.25000*HO +  0.25000*HO2 +  0.08000*MO2 +  0.10000*ACO3 +  0.10000*MACP +  0.09000*H2O2 +  0.14000*CO +  0.58000*HCHO +  0.46100*MACR +  0.18900*MVK +  0.28000*ORA1 +  0.15300*OLT ';
...
% 136, <R131>
i=i+1;
Rnames{ 136} = 'API + O3 = 0.90000*HO +  0.90000*APIP1 +  0.05000*APIP2 +  0.05000*PINAL +  0.05000*H2O2 +  0.14000*CO ';
...
% 137, <R132>
i=i+1;
Rnames{ 137} = 'LIM + O3 = 0.84000*HO +  0.84000*LIMP1 +  0.11000*LIMP2 +  0.05000*LIMAL +  0.05000*H2O2 +  0.14000*CO ';
...
% 138, <TRP08>
i=i+1;
Rnames{ 138} = 'LIMAL + O3 = 0.04000*HO +  0.67000*HC10P +  0.79000*HCHO +  0.33000*KET +  0.04000*HO2 +  0.20000*CO ';
k(:,i) = (  8.3000E-18 ); 
...
% 140, <R132>
i=i+1;
Rnames{ 140} = 'MACR + O3 = 0.19000*HO +  0.14000*HO2 +  0.10000*ACO3 +  0.22000*CO +  0.50000*MGLY +  0.45000*ORA1 ';
...
% 141, <R134>
i=i+1;
Rnames{ 141} = 'MVK + O3 = 0.16000*HO +  0.11000*HO2 +  0.28000*ACO3 +  0.01000*XO2 +  0.56000*CO +  0.10000*HCHO +  0.54000*MGLY +  0.07000*ORA1 +  0.07000*ORA2 +  0.10000*ALD ';
...
% 142, <R135>
i=i+1;
Rnames{ 142} = 'UALD + O3 = 0.10000*HO +  0.07200*HO2 +  0.00800*MO2 +  0.00200*ACO3 +  0.10000*XO2 +  0.24300*CO +  0.08000*HCHO +  0.42000*ACD +  0.02800*KET +  0.49100*GLY +  0.00300*MGLY +  0.04400*ORA1 ';
k(:,i) = (  1.6600E-18 ); 
...
% 143, <R136>
i=i+1;
Rnames{ 143} = 'DCB1 + O3 = 0.05000*HO + HO2 +  0.60000*RCO3 +  0.60000*XO2 +  1.50000*CO +  0.05000*HCHO +  0.05000*GLY +  0.08000*MGLY +  0.65000*OP2 ';
k(:,i) = (  2.0000E-16 ); 
...
% 144, <R137>
i=i+1;
Rnames{ 144} = 'DCB2 + O3 = 0.05000*HO + HO2 +  0.60000*RCO3 +  0.60000*XO2 +  1.50000*CO +  0.05000*HCHO +  0.05000*GLY +  0.08000*MGLY +  0.70000*DCB1 +  0.65000*OP2 ';
k(:,i) = (  2.0000E-16 ); 
...
% 145, <R138>
i=i+1;
Rnames{ 145} = 'DCB3 + O3 = 0.05000*HO + HO2 +  1.50000*CO +  0.48000*GLY +  0.70000*DCB1 +  0.25000*ORA1 +  0.25000*ORA2 +  0.11000*PAA ';
k(:,i) = (  9.0000E-17 ); 
...
% 147, <R141>
i=i+1;
Rnames{ 147} = 'ETE + NO3 = 0.80000*OLNN +  0.20000*OLND ';
...
% 148, <R142>
i=i+1;
Rnames{ 148} = 'OLT + NO3 = 0.43000*OLNN +  0.57000*OLND ';
...
% 149, <R143>
i=i+1;
Rnames{ 149} = 'OLI + NO3 = 0.11000*OLNN +  0.89000*OLND ';
...
% 151, <R146>
i=i+1;
Rnames{ 151} = 'API + NO3 = 0.97500*APINP1 +  0.02500*APINP2 ';
...
% 152, <R147>
i=i+1;
Rnames{ 152} = 'LIM + NO3 = 0.94500*LIMNP1 +  0.05500*LIMNP2 ';
k(:,i) = (  1.2200E-11 ); 
...
% 154, <R148>
i=i+1;
Rnames{ 154} = 'HCHO + NO3 = HO2 + CO + HNO3 ';
...
% 157, <R151>
i=i+1;
Rnames{ 157} = 'MACR + NO3 = 0.68000*HCHO +  0.32000*MACP +  0.68000*XO2 +  0.68000*MGLY +  0.32000*HNO3 +  0.68000*NO2 ';
k(:,i) = (  3.4000E-15 ); 
...
% 158, <R152>
i=i+1;
Rnames{ 158} = 'UALD + NO3 = HO2 + XO2 +  0.66800*CO +  0.33200*HCHO +  0.33200*ALD + ONIT ';
...
% 159, <R153>
i=i+1;
Rnames{ 159} = 'GLY + NO3 = HO2 +  2.00000*CO + HNO3 ';
...
% 160, <R154>
i=i+1;
Rnames{ 160} = 'MGLY + NO3 = ACO3 + CO + HNO3 ';
k(:,i) = (  3.7600E-12.*exp( -1.9000E+03./T) ); 
...
% 161, <R155>
i=i+1;
Rnames{ 161} = 'PHEN + NO3 = 0.15200*ASOATJ +  0.33900*CHO +  0.85000*ADDC +  0.42400*ADCN +  0.42400*HNO3 ';
k(:,i) = (  3.7800E-12 ); 
...
% 162, <R156>
i=i+1;
Rnames{ 162} = 'CSL + NO3 = 0.20000*ASOATJ +  0.32000*CHO +  0.08000*ADDC +  0.40000*ADCN +  0.40000*HNO3 ';
k(:,i) = (  1.0600E-12 ); 
...
% 170, <R169>
i=i+1;
Rnames{ 170} = 'PPN = RCO3 + NO2 ';
k(:,i) = (  1.1111E+28.*exp( -1.4000E+04./T).*k(:, 169) ); 
Gstr{i,   1}='PPN';
fPPN(i)=fPPN(i)-1.0;
...
% 173, <R172>
i=i+1;
Rnames{ 173} = 'MO2 + NO = HO2 + NO2 + HCHO ';
...
% 174, <R173>
i=i+1;
Rnames{ 174} = 'ETHP + NO = HO2 + NO2 + ACD ';
...
% 175, <R174>
i=i+1;
Rnames{ 175} = 'HC3P + NO = 0.66000*HO2 +  0.13100*MO2 +  0.04800*ETHP +  0.08900*XO2 +  0.93500*NO2 +  0.50400*ACD +  0.13200*ALD +  0.16500*ACT +  0.04200*MEK +  0.06500*ONIT ';
k(:,i) = (  4.0000E-12 ); 
...
% 176, <R175>
i=i+1;
Rnames{ 176} = 'HC5P + NO = 0.20000*HO2 +  0.05100*MO2 +  0.23100*ETHP +  0.23500*XO2 +  0.86400*NO2 +  0.01800*HCHO +  0.04500*ACD +  0.20300*ALD +  0.03300*MEK +  0.21700*ACT +  0.03300*KET +  0.27200*HKET +  0.13600*ONIT ';
k(:,i) = (  4.0000E-12 ); 
...
% 177, <R177>
i=i+1;
Rnames{ 177} = 'ETEP + NO = HO2 + NO2 +  1.60000*HCHO +  0.20000*ALD ';
k(:,i) = (  9.0000E-12 ); 
...
% 178, <R178>
i=i+1;
Rnames{ 178} = 'OLTP + NO = 0.78000*HO2 +  0.97000*NO2 +  0.78000*HCHO +  0.01200*ACD +  0.44000*ALD +  0.06000*ACT +  0.13000*MEK +  0.03000*ONIT ';
k(:,i) = (  4.0000E-12 ); 
...
% 179, <R179>
i=i+1;
Rnames{ 179} = 'OLIP + NO = 0.83000*HO2 +  0.95000*NO2 +  0.81000*ACD +  0.68000*ALD +  0.20000*ACT +  0.09000*KET +  0.02000*HKET +  0.05000*ONIT ';
k(:,i) = (  4.0000E-12 ); 
...
% 180, <ROCARO33>
i=i+1;
Rnames{ 180} = 'BENP + NO = 0.00000*ONIT +  0.00120*VROCP4OXY2 +  0.00080*VROCN1OXY6 +  0.99800*NO2 +  0.99800*HO2 +  0.00000*BALD +  0.99800*GLY +  0.49900*FURANONE +  0.24950*DCB2 +  0.24950*DCB3 ';
...
% 181, <ROCARO43>
i=i+1;
Rnames{ 181} = 'TOLP + NO = 0.00020*ONIT +  0.00130*VROCP4OXY2 +  0.00060*VROCN1OXY6 +  0.99800*NO2 +  0.99800*HO2 +  0.08520*BALD +  0.54770*GLY +  0.36510*MGLY +  0.36510*FURANONE +  0.54770*DCB1 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 182, <ROCARO53>
i=i+1;
Rnames{ 182} = 'XYMP + NO = 0.00010*ONIT +  0.00130*VROCP3OXY2 +  0.00060*VROCP0OXY4 +  0.99800*NO2 +  0.99800*HO2 +  0.04810*BALD +  0.70290*GLY +  0.24700*MGLY +  0.35150*FURANONE +  0.59840*DCB2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 183, <ROCARO63>
i=i+1;
Rnames{ 183} = 'XYEP + NO = 0.00020*ONIT +  0.00130*VROCP3OXY2 +  0.00060*VROCP0OXY4 +  0.99800*NO2 +  0.99800*HO2 +  0.08520*BALD +  0.54770*GLY +  0.36510*MGLY +  0.45640*FURANONE +  0.45640*DCB2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 184, <R188>
i=i+1;
Rnames{ 184} = 'ISOP + NO = 0.88000*HO2 +  0.88000*NO2 +  0.20000*HCHO +  0.28000*MACR +  0.44000*MVK +  0.12000*ISON +  0.02100*GLY +  0.02900*HKET +  0.02700*ALD ';
...
% 185, <R189>
i=i+1;
Rnames{ 185} = 'APIP1 + NO = 0.82000*HO2 +  0.82000*NO2 +  0.82000*PINAL +  0.18000*TRPN ';
k(:,i) = (  4.0000E-12 ); 
...
% 186, <TRP13>
i=i+1;
Rnames{ 186} = 'APIP2 + NO = 0.82000*HO +  0.82000*NO2 + HOM ';
k(:,i) = (  4.0000E-12 ); 
...
% 187, <TRP14>
i=i+1;
Rnames{ 187} = 'APINP1 + NO = 2.00000*NO2 + PINAL ';
k(:,i) = (  4.0000E-12 ); 
...
% 188, <TRP15>
i=i+1;
Rnames{ 188} = 'APINP2 + NO = 0.82000*NO2 +  0.82000*HO + HOM ';
k(:,i) = (  4.0000E-12 ); 
...
% 189, <R190>
i=i+1;
Rnames{ 189} = 'LIMP1 + NO = 0.77000*HO2 +  0.77000*NO2 +  0.49000*LIMAL +  0.28000*HCHO +  0.28000*UALD +  0.23000*TRPN ';
k(:,i) = (  4.0000E-12 ); 
...
% 190, <TRP16>
i=i+1;
Rnames{ 190} = 'LIMP2 + NO = 0.77000*HO +  0.77000*NO2 + HOM ';
k(:,i) = (  4.0000E-12 ); 
...
% 191, <TRP17>
i=i+1;
Rnames{ 191} = 'LIMNP1 + NO = 2.00000*NO2 + LIMAL ';
k(:,i) = (  4.0000E-12 ); 
...
% 192, <TRP18>
i=i+1;
Rnames{ 192} = 'LIMNP2 + NO = 0.77000*NO2 +  0.77000*HO + HOM ';
k(:,i) = (  4.0000E-12 ); 
...
% 193, <TRP19>
i=i+1;
Rnames{ 193} = 'PINALP + NO = 0.95000*HO2 +  0.95000*NO2 +  0.05000*TRPN +  0.95000*HCHO +  0.95000*KET ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 194, <TRP20>
i=i+1;
Rnames{ 194} = 'LIMALP + NO = 0.94000*HO2 +  0.94000*NO2 +  0.06000*TRPN +  0.94000*HCHO +  0.94000*KET ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 197, <R193>
i=i+1;
Rnames{ 197} = 'ACTP + NO = ACO3 + NO2 + HCHO ';
...
% 198, <R194>
i=i+1;
Rnames{ 198} = 'MEKP + NO = 0.67000*HO2 + NO2 +  0.33000*HCHO +  0.67000*DCB1 ';
k(:,i) = (  4.0000E-12 ); 
...
% 199, <R195>
i=i+1;
Rnames{ 199} = 'KETP + NO = 0.77000*HO2 +  0.23000*ACO3 +  0.16000*XO2 + NO2 +  0.46000*ALD +  0.54000*MGLY ';
k(:,i) = (  4.0000E-12 ); 
...
% 200, <R196>
i=i+1;
Rnames{ 200} = 'MACP + NO = 0.65000*MO2 +  0.35000*ACO3 + NO2 +  0.65000*CO +  0.65000*HCHO ';
...
% 201, <R197>
i=i+1;
Rnames{ 201} = 'MCP + NO = NO2 +  0.50000*HO2 +  0.50000*HCHO + HKET ';
k(:,i) = (  2.5400E-12.*exp(  3.6000E+02./T) ); 
...
% 202, <R198>
i=i+1;
Rnames{ 202} = 'MVKP + NO = 0.30000*HO2 +  0.70000*ACO3 +  0.70000*XO2 + NO2 +  0.30000*HCHO +  0.70000*ALD +  0.30000*MGLY ';
k(:,i) = (  2.5400E-12.*exp(  3.6000E+02./T) ); 
...
% 203, <R199>
i=i+1;
Rnames{ 203} = 'UALP + NO = HO2 + NO2 +  0.61000*CO +  0.03000*HCHO +  0.27000*ALD +  0.18000*GLY +  0.70000*KET +  0.21000*MGLY ';
k(:,i) = (  2.5400E-12.*exp(  3.6000E+02./T) ); 
...
% 206, <R202>
i=i+1;
Rnames{ 206} = 'ADDC + NO = HO2 + NO2 +  0.32000*HKET +  0.68000*GLY +  0.68000*OP2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 208, <R204>
i=i+1;
Rnames{ 208} = 'ORAP + NO = NO2 + GLY + HO2 ';
k(:,i) = (  4.0000E-12 ); 
...
% 209, <R205>
i=i+1;
Rnames{ 209} = 'OLNN + NO = NO2 + HO2 + ONIT ';
k(:,i) = (  4.0000E-12 ); 
...
% 210, <R206>
i=i+1;
Rnames{ 210} = 'OLND + NO = 2.00000*NO2 +  0.28700*HCHO +  1.24000*ALD +  0.46400*KET ';
k(:,i) = (  4.0000E-12 ); 
...
% 211, <R207>
i=i+1;
Rnames{ 211} = 'ADCN + NO = 2.00000*NO2 + GLY + OP2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 223, <ROCARO32>
i=i+1;
Rnames{ 223} = 'BENP + HO2 = 0.60210*OP2 +  0.39790*VROCN1OXY6 ';
...
% 224, <ROCARO42>
i=i+1;
Rnames{ 224} = 'TOLP + HO2 = 0.71950*OP2 +  0.28050*VROCN1OXY6 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
...
% 225, <ROCARO52>
i=i+1;
Rnames{ 225} = 'XYMP + HO2 = 0.04820*OP2 +  0.67470*OP3 +  0.27710*VROCP0OXY4 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
...
% 226, <ROCARO62>
i=i+1;
Rnames{ 226} = 'XYEP + HO2 = 0.08540*OP2 +  0.63410*OP3 +  0.28050*VROCP0OXY4 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
...
% 238, <R231>
i=i+1;
Rnames{ 238} = 'ACO3 + HO2 = 0.44000*HO +  0.44000*MO2 +  0.15000*ORA2 +  0.41000*PAA ';
...
% 239, <R232>
i=i+1;
Rnames{ 239} = 'RCO3 + HO2 = 0.44000*HO +  0.44000*ETHP +  0.15000*ORA2 +  0.41000*PAA ';
k(:,i) = (  4.3000E-13.*exp(  1.0400E+03./T) ); 
...
% 240, <R233>
i=i+1;
Rnames{ 240} = 'ACTP + HO2 = 0.15000*HO +  0.15000*ACO3 +  0.15000*HCHO +  0.85000*OP2 ';
...
% 255, <R248>
i=i+1;
Rnames{ 255} = 'MO2 + MO2 = 0.74000*HO2 +  1.37000*HCHO +  0.63000*MOH ';
...
% 256, <R249>
i=i+1;
Rnames{ 256} = 'ETHP + MO2 = HO2 +  0.75000*HCHO +  0.75000*ACD +  0.25000*MOH +  0.25000*EOH ';
...
% 257, <R250>
i=i+1;
Rnames{ 257} = 'HC3P + MO2 = 0.89400*HO2 +  0.08000*MO2 +  0.02600*ETHP +  0.02600*XO2 +  0.82700*HCHO +  0.19800*ALD +  0.49700*KET +  0.05000*GLY +  0.25000*MOH +  0.25000*ROH ';
...
% 258, <R251>
i=i+1;
Rnames{ 258} = 'HC5P + MO2 = 0.84200*HO2 +  0.01800*MO2 +  0.14000*ETHP +  0.19100*XO2 +  0.77700*HCHO +  0.25100*ALD +  0.61800*KET +  0.25000*MOH +  0.25000*ROH ';
...
% 259, <R253>
i=i+1;
Rnames{ 259} = 'ETEP + MO2 = HO2 +  1.95000*HCHO +  0.15000*ALD +  0.25000*MOH +  0.25000*ETEG ';
...
% 260, <R254>
i=i+1;
Rnames{ 260} = 'OLTP + MO2 = HO2 +  1.50000*HCHO +  0.70500*ALD +  0.04500*KET +  0.25000*MOH +  0.25000*ROH ';
...
% 261, <R255>
i=i+1;
Rnames{ 261} = 'OLIP + MO2 = HO2 +  0.75000*HCHO +  1.28000*ALD +  0.21800*KET +  0.25000*MOH +  0.25000*ROH ';
...
% 262, <ROCARO35>
i=i+1;
Rnames{ 262} = 'BENP + MO2 = 0.68000*HCHO +  1.37000*HO2 +  0.32000*MOH +  0.00000*BALD + GLY +  0.50000*FURANONE +  0.25000*DCB2 +  0.25000*DCB3 ';
...
% 263, <ROCARO45>
i=i+1;
Rnames{ 263} = 'TOLP + MO2 = 0.68000*HCHO +  1.28460*HO2 +  0.32000*MOH +  0.08540*BALD +  0.54880*GLY +  0.36590*MGLY +  0.36590*FURANONE +  0.54880*DCB1 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 264, <ROCARO55>
i=i+1;
Rnames{ 264} = 'XYMP + MO2 = 0.68000*HCHO +  1.32180*HO2 +  0.32000*MOH +  0.04820*BALD +  0.70430*GLY +  0.24750*MGLY +  0.35220*FURANONE +  0.59960*DCB2 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 265, <ROCARO65>
i=i+1;
Rnames{ 265} = 'XYEP + MO2 = 0.68000*HCHO +  1.28460*HO2 +  0.32000*MOH +  0.08540*BALD +  0.54880*GLY +  0.36590*MGLY +  0.45730*FURANONE +  0.45730*DCB2 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 266, <R264>
i=i+1;
Rnames{ 266} = 'ISOP + MO2 = HO2 +  1.31000*HCHO +  0.15900*MACR +  0.25000*MVK +  0.25000*MOH +  0.25000*ROH +  0.02300*ALD +  0.01800*GLY +  0.01600*HKET ';
...
% 267, <R265>
i=i+1;
Rnames{ 267} = 'APIP1 + MO2 = HO2 +  0.68000*HCHO +  0.60000*PINAL +  0.07000*KET +  0.32000*MOH +  0.25000*ROH ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 268, <TRP29>
i=i+1;
Rnames{ 268} = 'APIP2 + MO2 = HO2 +  0.75000*HCHO +  0.25000*MOH + HOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 269, <TRP30>
i=i+1;
Rnames{ 269} = 'APINP1 + MO2 = 0.37000*HO2 +  0.86000*NO2 +  0.68000*HCHO +  0.86000*PINAL +  0.32000*MOH +  0.14000*TRPN ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 270, <TRP31>
i=i+1;
Rnames{ 270} = 'APINP2 + MO2 = 0.75000*HO2 +  0.75000*NO2 +  0.25000*MOH +  0.75000*HCHO + HOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 271, <R266>
i=i+1;
Rnames{ 271} = 'LIMP1 + MO2 = HO2 + HCHO +  0.42000*LIMAL +  0.30000*KET +  0.32000*MOH +  0.27000*ROH ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 272, <TRP32>
i=i+1;
Rnames{ 272} = 'LIMP2 + MO2 = HO2 +  0.75000*HCHO +  0.25000*MOH + HOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 273, <TRP33>
i=i+1;
Rnames{ 273} = 'LIMNP1 + MO2 = 0.37000*HO2 +  0.68000*HCHO +  0.70000*LIMAL +  0.70000*NO2 +  0.32000*MOH +  0.30000*TRPN ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 274, <TRP34>
i=i+1;
Rnames{ 274} = 'LIMNP2 + MO2 = 0.75000*HO2 +  0.75000*HCHO +  0.75000*NO2 +  0.25000*MOH + HOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 275, <R267>
i=i+1;
Rnames{ 275} = 'ACO3 + MO2 = 0.90000*HO2 +  0.90000*MO2 + HCHO +  0.10000*ORA2 ';
...
% 276, <R268>
i=i+1;
Rnames{ 276} = 'RCO3 + MO2 = 0.90000*HO2 +  0.90000*MO2 + HCHO +  0.10000*ORA2 ';
k(:,i) = (  2.0000E-11.*exp(  5.0000E+02./T) ); 
...
% 277, <R269>
i=i+1;
Rnames{ 277} = 'ACTP + MO2 = 0.50000*HO2 +  0.50000*ACO3 +  1.50000*HCHO +  0.25000*MOH +  0.25000*ROH +  0.12500*ORA2 ';
...
% 278, <R270>
i=i+1;
Rnames{ 278} = 'MEKP + MO2 = 0.83400*HO2 + HCHO +  0.33400*DCB1 +  0.25000*MOH +  0.25000*ROH ';
...
% 279, <R271>
i=i+1;
Rnames{ 279} = 'KETP + MO2 = HO2 +  0.75000*HCHO +  0.50000*DCB1 +  0.25000*MOH +  0.25000*ROH ';
k(:,i) = (  6.9100E-13.*exp(  5.0800E+02./T) ); 
...
% 280, <R272>
i=i+1;
Rnames{ 280} = 'MACP + MO2 = 0.50000*HO2 +  0.26900*ACO3 +  0.50000*CO +  1.66000*HCHO +  0.06700*ORA2 +  0.25000*MO2 +  0.25000*MOH +  0.25000*ROH ';
k(:,i) = (  3.4000E-14.*exp(  2.2100E+02./T) ); 
...
% 281, <R273>
i=i+1;
Rnames{ 281} = 'MCP + MO2 = NO2 + HO2 +  1.50000*HCHO +  0.50000*HKET +  0.25000*MOH +  0.25000*ROH ';
k(:,i) = (  3.4000E-14.*exp(  2.2100E+02./T) ); 
...
% 282, <R274>
i=i+1;
Rnames{ 282} = 'MVKP + MO2 = HO2 +  1.16000*ACO3 +  1.16000*XO2 +  1.50000*HCHO +  1.75000*ALD +  0.50000*MGLY +  0.25000*MOH +  0.25000*ROH +  0.29200*ORA2 ';
k(:,i) = (  8.3700E-14 ); 
...
% 283, <R275>
i=i+1;
Rnames{ 283} = 'UALP + MO2 = HO2 +  0.30500*CO +  0.77300*HCHO +  0.20300*ALD +  0.52500*KET +  0.13500*GLY +  0.10500*MGLY +  0.25000*MOH +  0.25000*ROH ';
k(:,i) = (  3.4000E-14.*exp(  2.2100E+02./T) ); 
...
% 284, <R276>
i=i+1;
Rnames{ 284} = 'BALP + MO2 = HO2 + BAL1 + HCHO ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 285, <R277>
i=i+1;
Rnames{ 285} = 'BAL1 + MO2 = HO2 + BAL2 + HCHO ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 286, <R278>
i=i+1;
Rnames{ 286} = 'ADDC + MO2 = 2.00000*HO2 + HCHO +  0.32000*HKET +  0.68000*GLY +  0.68000*OP2 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 287, <R279>
i=i+1;
Rnames{ 287} = 'MCTP + MO2 = HO2 + MCTO + HCHO ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 288, <R280>
i=i+1;
Rnames{ 288} = 'ORAP + MO2 = HCHO + HO2 + GLY ';
k(:,i) = (  7.5000E-13.*exp(  5.0000E+02./T) ); 
...
% 289, <R281>
i=i+1;
Rnames{ 289} = 'OLNN + MO2 = 2.00000*HO2 + HCHO + ONIT ';
...
% 290, <R282>
i=i+1;
Rnames{ 290} = 'OLND + MO2 = 0.50000*HO2 +  0.50000*NO2 +  0.96500*HCHO +  0.93000*ALD +  0.34800*KET +  0.25000*MOH +  0.25000*ROH +  0.50000*ONIT ';
...
% 291, <R283>
i=i+1;
Rnames{ 291} = 'ADCN + MO2 = HO2 +  0.70000*NO2 + HCHO +  0.70000*GLY +  0.70000*OP2 +  0.30000*ONIT ';
k(:,i) = (  3.5600E-14 ); 
...
% 293, <R285>
i=i+1;
Rnames{ 293} = 'ETHP + ACO3 = 0.50000*HO2 +  0.50000*MO2 + ACD +  0.50000*ORA2 ';
...
% 294, <R286>
i=i+1;
Rnames{ 294} = 'HC3P + ACO3 = 0.39400*HO2 +  0.58000*MO2 +  0.02600*ETHP +  0.02600*XO2 +  0.13000*HCHO +  0.27300*ALD +  0.66200*KET +  0.06700*GLY +  0.50000*ORA2 ';
...
% 295, <R287>
i=i+1;
Rnames{ 295} = 'HC5P + ACO3 = 0.34200*HO2 +  0.51800*MO2 +  0.14000*ETHP +  0.19100*XO2 +  0.04200*HCHO +  0.38100*ALD +  0.82400*KET +  0.50000*ORA2 ';
...
% 296, <R289>
i=i+1;
Rnames{ 296} = 'ETEP + ACO3 = 0.50000*HO2 +  0.50000*MO2 +  1.60000*HCHO +  0.20000*ALD +  0.50000*ORA2 ';
...
% 297, <R290>
i=i+1;
Rnames{ 297} = 'OLTP + ACO3 = 0.50000*HO2 +  0.50000*MO2 + HCHO +  0.94000*ALD +  0.06000*KET +  0.50000*ORA2 ';
...
% 298, <R291>
i=i+1;
Rnames{ 298} = 'OLIP + ACO3 = 0.50000*HO2 +  0.50000*MO2 +  1.71000*ALD +  0.29000*KET +  0.50000*ORA2 ';
...
% 299, <ROCARO36>
i=i+1;
Rnames{ 299} = 'BENP + ACO3 = 0.70000*MO2 + HO2 +  0.30000*ORA2 +  0.00000*BALD + GLY +  0.50000*FURANONE +  0.25000*DCB2 +  0.25000*DCB3 ';
...
% 300, <ROCARO46>
i=i+1;
Rnames{ 300} = 'TOLP + ACO3 = 0.70000*MO2 +  0.91460*HO2 +  0.30000*ORA2 +  0.08540*BALD +  0.54880*GLY +  0.36590*MGLY +  0.36590*FURANONE +  0.54880*DCB1 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
...
% 301, <ROCARO56>
i=i+1;
Rnames{ 301} = 'XYMP + ACO3 = 0.70000*MO2 +  0.95180*HO2 +  0.30000*ORA2 +  0.04820*BALD +  0.70430*GLY +  0.24750*MGLY +  0.35220*FURANONE +  0.59960*DCB2 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
...
% 302, <ROCARO66>
i=i+1;
Rnames{ 302} = 'XYEP + ACO3 = 0.70000*MO2 +  0.91460*HO2 +  0.30000*ORA2 +  0.08540*BALD +  0.54880*GLY +  0.36590*MGLY +  0.45730*FURANONE +  0.45730*DCB2 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
...
% 303, <R300>
i=i+1;
Rnames{ 303} = 'ISOP + ACO3 = 0.50000*HO2 +  0.50000*MO2 +  1.04800*HCHO +  0.21900*MACR +  0.30500*MVK +  0.50000*ORA2 ';
...
% 304, <R301>
i=i+1;
Rnames{ 304} = 'APIP1 + ACO3 = 0.63000*HO2 +  0.70000*MO2 +  0.60000*PINAL +  0.30000*ORA2 +  0.07000*KET +  0.25000*ROH ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
...
% 305, <TRP35>
i=i+1;
Rnames{ 305} = 'APIP2 + ACO3 = 0.50000*HO +  0.50000*MO2 +  0.50000*ORA2 + HOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 306, <TRP36>
i=i+1;
Rnames{ 306} = 'APINP1 + ACO3 = 0.86000*NO2 +  0.14000*TRPN +  0.86000*PINAL +  0.70000*MO2 +  0.30000*ORA2 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
...
% 307, <TRP37>
i=i+1;
Rnames{ 307} = 'APINP2 + ACO3 = 0.50000*NO2 +  0.50000*MO2 +  0.50000*ORA2 + HOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 308, <R302>
i=i+1;
Rnames{ 308} = 'LIMP1 + ACO3 = 0.63000*HO2 +  0.70000*MO2 +  0.42000*LIMAL +  0.30000*KET +  0.30000*ORA2 +  0.32000*HCHO +  0.27000*ROH ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
...
% 309, <TRP38>
i=i+1;
Rnames{ 309} = 'LIMP2 + ACO3 = 0.50000*HO +  0.50000*MO2 +  0.50000*ORA2 + HOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 310, <TRP39>
i=i+1;
Rnames{ 310} = 'LIMNP1 + ACO3 = 0.70000*NO2 +  0.70000*LIMAL +  0.30000*TRPN +  0.70000*MO2 +  0.30000*ORA2 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
...
% 311, <TRP40>
i=i+1;
Rnames{ 311} = 'LIMNP2 + ACO3 = 0.50000*MO2 +  0.50000*NO2 +  0.50000*ORA2 + HOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 312, <R303>
i=i+1;
Rnames{ 312} = 'ACO3 + ACO3 = 2.00000*MO2 ';
...
% 314, <R305>
i=i+1;
Rnames{ 314} = 'ACTP + ACO3 = 0.50000*MO2 +  0.50000*ACO3 + HCHO +  0.75000*ORA2 ';
...
% 315, <R306>
i=i+1;
Rnames{ 315} = 'MEKP + ACO3 = 0.33000*HO2 +  0.50000*MO2 +  0.33000*HCHO +  0.33400*DCB1 +  0.50000*ORA2 ';
k(:,i) = (  7.5100E-13.*exp(  5.6500E+02./T) ); 
...
% 316, <R307>
i=i+1;
Rnames{ 316} = 'KETP + ACO3 = 0.50000*HO2 +  0.50000*MO2 +  0.50000*DCB1 +  0.50000*ORA2 ';
k(:,i) = (  7.5100E-13.*exp(  5.6500E+02./T) ); 
...
% 317, <R308>
i=i+1;
Rnames{ 317} = 'MACP + ACO3 = 0.63500*ORA2 +  0.50000*MO2 +  0.26900*ACO3 +  0.50000*CO + HCHO ';
k(:,i) = (  8.4000E-14.*exp(  2.2100E+02./T) ); 
...
% 318, <R309>
i=i+1;
Rnames{ 318} = 'MCP + ACO3 = NO2 +  0.50000*HO2 + HCHO +  0.50000*HKET +  0.50000*MO2 +  0.50000*ORA2 ';
k(:,i) = (  8.4000E-14.*exp(  2.2100E+02./T) ); 
...
% 319, <R310>
i=i+1;
Rnames{ 319} = 'MVKP + ACO3 = 0.50000*HO2 +  0.50000*MO2 +  1.16000*ACO3 +  1.16000*XO2 + HCHO +  2.30000*ALD +  0.50000*MGLY +  1.08300*ORA2 ';
...
% 320, <R311>
i=i+1;
Rnames{ 320} = 'UALP + ACO3 = 0.50000*HO2 +  0.50000*MO2 +  0.50000*CO +  0.03000*HCHO +  0.27000*ALD +  0.70000*KET +  0.18000*GLY +  0.10500*MGLY +  0.50000*ORA2 ';
k(:,i) = (  1.6800E-12.*exp(  5.0000E+02./T) ); 
...
% 323, <R314>
i=i+1;
Rnames{ 323} = 'ADDC + ACO3 = 2.00000*HO2 + MO2 +  0.32000*HKET +  0.68000*GLY +  0.68000*OP2 ';
...
% 324, <R315>
i=i+1;
Rnames{ 324} = 'MCTP + ACO3 = HO2 + MO2 + MCTO ';
k(:,i) = (  7.4000E-13.*exp(  7.0800E+02./T) ); 
...
% 326, <R317>
i=i+1;
Rnames{ 326} = 'OLNN + ACO3 = HO2 + MO2 + ONIT ';
...
% 327, <R318>
i=i+1;
Rnames{ 327} = 'OLND + ACO3 = 0.50000*MO2 + NO2 +  0.28700*HCHO +  1.24000*ALD +  0.46400*KET +  0.50000*ORA2 ';
...
% 328, <R319>
i=i+1;
Rnames{ 328} = 'ADCN + ACO3 = HO2 + MO2 +  0.70000*NO2 +  0.70000*GLY +  0.70000*OP2 +  0.30000*ONIT ';
k(:,i) = (  7.4000E-13.*exp(  7.0800E+02./T) ); 
...
% 330, <R321>
i=i+1;
Rnames{ 330} = 'RCO3 + RCO3 = 2.00000*ETHP ';
k(:,i) = (  2.5000E-12.*exp(  5.0000E+02./T) ); 
...
% 331, <R322>
i=i+1;
Rnames{ 331} = 'MO2 + NO3 = HO2 + HCHO + NO2 ';
k(:,i) = (  1.2000E-12 ); 
...
% 332, <R323>
i=i+1;
Rnames{ 332} = 'ETHP + NO3 = HO2 + NO2 + ACD ';
k(:,i) = (  1.2000E-12 ); 
...
% 333, <R324>
i=i+1;
Rnames{ 333} = 'HC3P + NO3 = 0.25400*HO2 +  0.14000*MO2 +  0.09200*XO2 +  0.50300*ETHP + NO2 +  0.51900*ACD +  0.14700*ALD +  0.07500*MEK +  0.09500*ACT ';
k(:,i) = (  1.2000E-12 ); 
...
% 334, <R325>
i=i+1;
Rnames{ 334} = 'HC5P + NO3 = 0.48800*HO2 +  0.05500*MO2 +  0.28000*ETHP +  0.48500*XO2 + NO2 +  0.02400*HCHO +  0.24100*ALD +  0.06000*KET +  0.06300*MEK +  0.24700*ACT +  0.04800*ACD +  0.27500*HKET ';
k(:,i) = (  1.2000E-12 ); 
...
% 335, <R327>
i=i+1;
Rnames{ 335} = 'ETEP + NO3 = HO2 + NO2 +  1.60000*HCHO +  0.20000*ALD ';
k(:,i) = (  1.2000E-12 ); 
...
% 336, <R328>
i=i+1;
Rnames{ 336} = 'OLTP + NO3 = 0.47000*ALD +  0.79000*HCHO +  0.79000*HO2 + NO2 +  0.18000*MEK +  0.02000*ACD +  0.09000*ACT ';
k(:,i) = (  1.2000E-12 ); 
...
% 337, <R329>
i=i+1;
Rnames{ 337} = 'OLIP + NO3 = 0.86000*HO2 +  0.72000*ALD +  0.11000*KET + NO2 +  0.20000*ACT +  0.85000*ACD +  0.04000*HKET ';
k(:,i) = (  1.2000E-12 ); 
...
% 338, <ROCARO34>
i=i+1;
Rnames{ 338} = 'BENP + NO3 = NO2 + HO2 +  0.00000*BALD + GLY +  0.50000*FURANONE +  0.25000*DCB2 +  0.25000*DCB3 ';
k(:,i) = (  2.3000E-12 ); 
...
% 339, <ROCARO44>
i=i+1;
Rnames{ 339} = 'TOLP + NO3 = NO2 +  0.91460*HO2 +  0.08540*BALD +  0.54880*GLY +  0.36590*MGLY +  0.36590*FURANONE +  0.54880*DCB1 ';
k(:,i) = (  2.3000E-12 ); 
...
% 340, <ROCARO54>
i=i+1;
Rnames{ 340} = 'XYMP + NO3 = NO2 +  0.95180*HO2 +  0.04820*BALD +  0.70430*GLY +  0.24750*MGLY +  0.35220*FURANONE +  0.59960*DCB2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 341, <ROCARO64>
i=i+1;
Rnames{ 341} = 'XYEP + NO3 = NO2 +  0.91460*HO2 +  0.08540*BALD +  0.54880*GLY +  0.36590*MGLY +  0.45730*FURANONE +  0.45730*DCB2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 342, <R338>
i=i+1;
Rnames{ 342} = 'ISOP + NO3 = HO2 + NO2 +  0.75000*HCHO +  0.31800*MACR +  0.50000*MVK +  0.02400*GLY +  0.03300*HKET +  0.03100*ALD ';
k(:,i) = (  1.2000E-12 ); 
...
% 343, <R339>
i=i+1;
Rnames{ 343} = 'APIP1 + NO3 = HO2 + NO2 + ALD + KET ';
k(:,i) = (  1.2000E-12 ); 
...
% 344, <R340>
i=i+1;
Rnames{ 344} = 'LIMP1 + NO3 = HO2 + NO2 +  0.38500*OLI +  0.38500*HCHO +  0.61500*MACR ';
k(:,i) = (  1.2000E-12 ); 
...
% 347, <R343>
i=i+1;
Rnames{ 347} = 'ACTP + NO3 = ACO3 + NO2 + HCHO ';
k(:,i) = (  1.2000E-12 ); 
...
% 348, <R344>
i=i+1;
Rnames{ 348} = 'MEKP + NO3 = 0.67000*HO2 + NO2 +  0.33000*HCHO +  0.67000*DCB1 ';
k(:,i) = (  1.2000E-12 ); 
...
% 349, <R345>
i=i+1;
Rnames{ 349} = 'KETP + NO3 = HO2 + NO2 + DCB1 ';
k(:,i) = (  1.2000E-12 ); 
...
% 350, <R346>
i=i+1;
Rnames{ 350} = 'MACP + NO3 = HCHO +  0.53800*ACO3 + CO + NO2 ';
k(:,i) = (  1.2000E-12 ); 
...
% 351, <R347>
i=i+1;
Rnames{ 351} = 'MCP + NO3 = NO2 + HO2 + HCHO + HKET ';
k(:,i) = (  1.2000E-12 ); 
...
% 352, <R348>
i=i+1;
Rnames{ 352} = 'MVKP + NO3 = 0.30000*HO2 +  0.70000*ACO3 +  0.70000*XO2 + NO2 +  0.30000*HCHO +  0.70000*ALD +  0.30000*MGLY ';
k(:,i) = (  2.5000E-12 ); 
...
% 353, <R349>
i=i+1;
Rnames{ 353} = 'UALP + NO3 = HO2 + NO2 +  0.61000*CO +  0.03000*HCHO +  0.27000*ALD +  0.70000*KET +  0.18000*GLY +  0.21000*MGLY ';
k(:,i) = (  2.5000E-12 ); 
...
% 356, <R352>
i=i+1;
Rnames{ 356} = 'ADDC + NO3 = HO2 + NO2 +  0.32000*HKET +  0.68000*GLY +  0.68000*OP2 ';
k(:,i) = (  1.2000E-12 ); 
...
% 358, <R354>
i=i+1;
Rnames{ 358} = 'ORAP + NO3 = NO2 + GLY + HO2 ';
k(:,i) = (  1.2000E-12 ); 
...
% 359, <R355>
i=i+1;
Rnames{ 359} = 'OLNN + NO3 = HO2 + NO2 + ONIT ';
k(:,i) = (  1.2000E-12 ); 
...
% 360, <R356>
i=i+1;
Rnames{ 360} = 'OLND + NO3 = 2.00000*NO2 +  0.28700*HCHO +  1.24000*ALD +  0.46400*KET ';
k(:,i) = (  1.2000E-12 ); 
...
% 361, <R357>
i=i+1;
Rnames{ 361} = 'ADCN + NO3 = 2.00000*NO2 + GLY + OP2 ';
k(:,i) = (  1.2000E-12 ); 
...
% 362, <R358>
i=i+1;
Rnames{ 362} = 'OLNN + OLNN = HO2 +  2.00000*ONIT ';
...
% 363, <R359>
i=i+1;
Rnames{ 363} = 'OLNN + OLND = 0.50000*HO2 +  0.50000*NO2 +  0.20200*HCHO +  0.64000*ALD +  0.14900*KET +  1.50000*ONIT ';
...
% 364, <R360>
i=i+1;
Rnames{ 364} = 'OLND + OLND = NO2 +  0.50400*HCHO +  1.21000*ALD +  0.28500*KET + ONIT ';
...
% 368, <TRP41>
i=i+1;
Rnames{ 368} = 'APIP2 + APIP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 369, <TRP42>
i=i+1;
Rnames{ 369} = 'APIP2 + LIMP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 370, <TRP43>
i=i+1;
Rnames{ 370} = 'APIP2 + ISOP = 0.96000*HOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 371, <TRP44>
i=i+1;
Rnames{ 371} = 'LIMP2 + APIP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 372, <TRP45>
i=i+1;
Rnames{ 372} = 'LIMP2 + LIMP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 373, <TRP46>
i=i+1;
Rnames{ 373} = 'LIMP2 + ISOP = 0.96000*HOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 374, <TRP47>
i=i+1;
Rnames{ 374} = 'APINP2 + APIP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 375, <TRP48>
i=i+1;
Rnames{ 375} = 'APINP2 + LIMP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 376, <TRP49>
i=i+1;
Rnames{ 376} = 'APINP2 + ISOP = 0.96000*HOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 377, <TRP50>
i=i+1;
Rnames{ 377} = 'LIMNP2 + APIP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 378, <TRP51>
i=i+1;
Rnames{ 378} = 'LIMNP2 + LIMP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 379, <TRP52>
i=i+1;
Rnames{ 379} = 'LIMNP2 + ISOP = 0.96000*HOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 381, <R001c>
i=i+1;
Rnames{ 381} = 'VROCIOXY + HO = 0.85200*ETHP +  0.14900*ASOATJ ';
k(:,i) = (  6.8900E-12 ); 
...
% 382, <R002c>
i=i+1;
Rnames{ 382} = 'SLOWROC + HO = ETHP +  0.00101*ASOATJ ';
k(:,i) = (  6.5500E-14 ); 
...
% 383, <T17>
i=i+1;
Rnames{ 383} = 'ACRO + HO = 0.57000*MACP +  0.43000*MCP ';
k(:,i) = (  8.0000E-12.*exp(  3.8000E+02./T) ); 
...
% 384, <T18>
i=i+1;
Rnames{ 384} = 'ACRO + O3 = 0.84000*CO +  0.56000*HO2 +  0.28000*HO +  0.72000*HCHO +  0.62000*GLY ';
k(:,i) = (  2.9000E-19 ); 
...
% 385, <T19>
i=i+1;
Rnames{ 385} = 'ACRO + NO3 = 0.68000*HCHO +  0.32000*MACP +  0.68000*XO2 +  0.68000*MGLY +  0.32000*HNO3 +  0.68000*NO2 ';
k(:,i) = (  3.4000E-15 ); 
...
% 386, <T20>
i=i+1;
Rnames{ 386} = 'ACRO = CO +  0.47700*HO2 +  0.25000*ETE +  0.35400*ACO3 +  0.20400*HO +  0.15000*HCHO +  0.02700*MO2 ';
k(:,i) = (JACRO_09 ); 
Gstr{i,   1}='ACRO';
fACRO(i)=fACRO(i)-1.0;
...
% 387, <T10>
i=i+1;
Rnames{ 387} = 'BDE13 + HO = 0.66700*BDE13P +  0.33300*UALD +  0.33300*HO2 ';
...
% 388, <T10a>
i=i+1;
Rnames{ 388} = 'BDE13P + NO = 0.96800*HO2 +  0.96800*NO2 +  0.89500*ACRO +  0.89500*HCHO +  0.07200*FURAN +  0.03200*ONIT ';
k(:,i) = (  9.0500E-12 ); 
...
% 389, <T10b>
i=i+1;
Rnames{ 389} = 'BDE13P + NO3 = HO2 + NO2 +  0.92500*ACRO +  0.92500*HCHO +  0.07500*FURAN ';
k(:,i) = (  2.3000E-12 ); 
...
% 391, <T10d>
i=i+1;
Rnames{ 391} = 'BDE13P + MO2 = 0.32000*MOH +  1.14300*HCHO +  0.87000*HO2 +  0.46300*ACRO +  0.25000*OLT +  0.23100*MVK +  0.03700*FURAN +  0.01900*UALD ';
k(:,i) = (  2.3900E-12 ); 
...
% 392, <T10e>
i=i+1;
Rnames{ 392} = 'BDE13P + ACO3 = 0.70000*MO2 +  0.30000*ORA2 +  0.80000*HO2 +  0.74000*ACRO +  0.74000*HCHO +  0.18500*MVK +  0.06000*FURAN +  0.01500*UALD ';
k(:,i) = (  1.3700E-11 ); 
...
% 393, <T11>
i=i+1;
Rnames{ 393} = 'BDE13 + O3 = 0.62000*ACRO +  0.63000*CO +  0.42000*HO2 +  0.08000*HO +  0.83000*HCHO +  0.17000*ETE ';
...
% 394, <T12>
i=i+1;
Rnames{ 394} = 'BDE13 + NO3 = 0.90000*OLNN +  0.10000*OLND +  0.90000*ACRO ';
k(:,i) = (  1.0000E-13 ); 
Gstr{i,   1}='BDE13';Gstr{i,   2}='NO3';
fBDE13(i)=fBDE13(i)-1.0;fNO3(i)=fNO3(i)-1.0;
fOLNN(i)=fOLNN(i)+  0.900;fOLND(i)=fOLND(i)+  0.100;fACRO(i)=fACRO(i)+  0.900;

% 395, <R003c>
i=i+1;
Rnames{ 395} = 'FURAN + HO = 0.49000*DCB1 +  0.49000*HO2 +  0.51000*FURANO2 ';
k(:,i) = (  5.0100E-11 ); 
...
% 396, <R004c>
i=i+1;
Rnames{ 396} = 'FURANO2 + NO = 0.08000*ONIT +  0.92000*NO2 +  0.92000*FURANONE +  0.75000*HO2 +  0.17000*MO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 397, <R005c>
i=i+1;
Rnames{ 397} = 'FURANO2 + HO2 = 0.60000*OP2 +  0.40000*FURANONE +  0.40000*HO +  0.32000*HO2 +  0.08000*MO2 ';
k(:,i) = (  3.7500E-13.*exp(  9.8000E+02./T) ); 
...
% 398, <R006c>
i=i+1;
Rnames{ 398} = 'FURANONE + HO = 0.65000*KET +  0.31000*GLY +  0.66000*HO2 +  0.34000*MO2 +  0.43000*CO +  0.04000*ASOATJ ';
k(:,i) = (  4.4000E-11 ); 
...
% 399, <R007c>
i=i+1;
Rnames{ 399} = 'FURAN + O3 = 0.02000*HO + ALD ';
k(:,i) = (  3.4300E-17 ); 
...
% 400, <R008c>
i=i+1;
Rnames{ 400} = 'FURAN + NO3 = NO2 +  0.80000*DCB1 +  0.20000*DCB3 ';
k(:,i) = (  8.9900E-12 ); 
...
% 401, <R010c>
i=i+1;
Rnames{ 401} = 'PROG + HO = 0.61300*HKET +  0.38700*ALD + HO2 ';
k(:,i) = (  1.2000E-11 ); 
...
% 403, <R012c>
i=i+1;
Rnames{ 403} = 'SESQNRO2 + HO2 = VROCP0OXY4 ';
...
% 404, <R013c>
i=i+1;
Rnames{ 404} = 'SESQNRO2 + NO = VROCP3OXY2 +  2.00000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 405, <R014c>
i=i+1;
Rnames{ 405} = 'SESQNRO2 + NO3 = VROCP3OXY2 +  2.00000*NO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 406, <R015c>
i=i+1;
Rnames{ 406} = 'SESQ + O3 = 0.98200*VROCP3OXY2 +  0.01800*VROCN2OXY2 ';
k(:,i) = (  1.2000E-14 ); 
...
% 408, <R017c>
i=i+1;
Rnames{ 408} = 'SESQRO2 + HO2 = VROCP0OXY2 ';
k(:,i) = (  2.8400E-13.*exp(  1.3000E+03./T) ); 
...
% 409, <R019c>
i=i+1;
Rnames{ 409} = 'SESQRO2 + NO3 = VROCP3OXY2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 410, <R020c>
i=i+1;
Rnames{ 410} = 'SESQRO2 + NO = 0.24700*VROCP1OXY3 +  0.75300*VROCP3OXY2 +  0.75300*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
