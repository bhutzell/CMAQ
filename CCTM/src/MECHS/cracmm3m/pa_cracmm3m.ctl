...
DEFINE FAMILY ISOPRENE_VOC = ISHP + MVK + MACR + ISON + ISONP + INALD
+ IPX + IEPOX;
...
DEFINE FAMILY HVSOA_VAPOXY = VROCP2OXY2 + VROCP3OXY2 + VOP3;
...
IRR_OUTPUT HNO3fromN2O5IJ = <HET_N2O5IJ>;
IRR_OUTPUT HNO3fromN2O5K = <HET_N2O5K>;
...
IRR_OUTPUT ORGNO3viaTERP = PROD[VTRPN]+PROD[VHONIT];
...
! Ozone loss from halogens
IRR_OUTPUT O3loss_CL = LOSS [O3] AND [CL];
IRR_OUTPUT O3loss_BR = LOSS [O3] AND [BR] + LOSS [O3] AND [OBRO];
IRR_OUTPUT O3loss_I  = LOSS [O3] AND [I];
