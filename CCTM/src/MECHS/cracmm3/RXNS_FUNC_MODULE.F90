...
!  Reaction Label CLP01           
                RKI( NCELL,  539) =  RJBLK( NCELL, IJ_CL2_JPL19 )
!  Reaction Label CLP02           
                RKI( NCELL,  540) =  RJBLK( NCELL, IJ_CLO_JPL19 )
!  Reaction Label CLP03           
                RKI( NCELL,  541) =  RJBLK( NCELL, IJ_OCLO_JPL19 )
!  Reaction Label CLP07           
                RKI( NCELL,  542) =  RJBLK( NCELL, IJ_CL2O2_JPL19 )
!  Reaction Label CLP10           
                RKI( NCELL,  543) =  RJBLK( NCELL, IJ_HOCL_JPL19 )
!  Reaction Label CLP12           
                RKI( NCELL,  544) =  RJBLK( NCELL, IJ_CLNO_JPL19 )
!  Reaction Label CLP14           
                RKI( NCELL,  545) =  RJBLK( NCELL, IJ_CLNO2_JPL19 )
!  Reaction Label CLP17           
                RKI( NCELL,  546) =  RJBLK( NCELL, IJ_CLNO3_R_JPL19 )
!  Reaction Label CLP18           
                RKI( NCELL,  547) =  RJBLK( NCELL, IJ_CLNO3_M_JPL19 )

                IF ( SEAWATER (NCELL) .GT. 0.001D0 ) THEN
!  Reaction Label HAL_Ozone       
                   RKI( NCELL,  430) = SEAWATER (NCELL) *  SFACT * HALOGEN_FALLOFF( BLKPRES( NCELL ),   1.0650D-12,   1.3906D+01,  & 
...
!  Reaction Label HET_IEPOX       
             RKI( NCELL,  431) =  BLKHET(  NCELL, IK_HETERO_IEPOX )
!  Reaction Label HET_ISO3TET     
             RKI( NCELL,  432) =  BLKHET(  NCELL, IK_HETERO_ISO3NOSJ )
!  Reaction Label HET_IEPOXOS     
             RKI( NCELL,  433) =  BLKHET(  NCELL, IK_HETERO_ISO3OSJ )
!  Reaction Label HET_IPX         
             RKI( NCELL,  434) =   2.0000D+00 * BLKHET( NCELL, IK_HETERO_IEPOX )
!  Reaction Label HET_INALD       
             RKI( NCELL,  435) =   5.0000D-01 * BLKHET( NCELL, IK_HETERO_IEPOX )
!  Reaction Label ROCALK1c        
             RKI( NCELL,  436) =   1.5300D-11 * CFACT 
!  Reaction Label ROCALK2c        
             RKI( NCELL,  437) =   1.6800D-11 * CFACT 
!  Reaction Label ROCALK3c        
             RKI( NCELL,  438) =   2.2400D-11 * CFACT 
!  Reaction Label ROCALK4c        
             RKI( NCELL,  439) =   2.6700D-11 * CFACT 
!  Reaction Label ROCALK5c        
             RKI( NCELL,  440) =   3.0900D-11 * CFACT 
!  Reaction Label ROCALK6c        
             RKI( NCELL,  441) =   3.3800D-11 * CFACT 
!  Reaction Label HC1001          
             RKI( NCELL,  442) =   1.1000D-11 * CFACT 
...
!  Reaction Label ROCALK43c       
             RKI( NCELL,  485) =   2.1700D-11 * CFACT 
!  Reaction Label ROCALK44c       
             RKI( NCELL,  486) =   2.2000D-11 * CFACT 
!  Reaction Label ROCALK45c       
             RKI( NCELL,  487) =   2.2500D-11 * CFACT 
!  Reaction Label ROCALK46c       
             RKI( NCELL,  488) =   2.2600D-11 * CFACT 
!  Reaction Label ROCALK47c       
             RKI( NCELL,  489) =   2.2700D-11 * CFACT 
!  Reaction Label ROCALK48c       
             RKI( NCELL,  490) =   2.2700D-11 * CFACT 
!  Reaction Label HC1008          
             RKI( NCELL,  491) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6600D-13,   1.3000D+03 )
...
!  Reaction Label ROCARO11        
             RKI( NCELL,  498) =   1.8100D-11 * CFACT 
...
!  Reaction Label ROCARO21        
             RKI( NCELL,  504) =   2.3100D-11 * CFACT 
!  Reaction Label ROCARO22        
             RKI( NCELL,  505) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label ROCARO23        
             RKI( NCELL,  506) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label ROCARO24        
             RKI( NCELL,  507) =   2.3000D-12 * CFACT 
!  Reaction Label ROCARO25        
             RKI( NCELL,  508) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label ROCARO26        
             RKI( NCELL,  509) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label ROCOXY1c        
             RKI( NCELL,  510) =   5.9000D-11 * CFACT 
!  Reaction Label ROCOXY2c        
             RKI( NCELL,  511) =   6.0700D-11 * CFACT 
!  Reaction Label ROCOXY3c        
             RKI( NCELL,  512) =   5.5400D-11 * CFACT 
!  Reaction Label ROCOXY4c        
             RKI( NCELL,  513) =   5.6300D-11 * CFACT 
!  Reaction Label ROCOXY5c        
             RKI( NCELL,  514) =   5.4600D-11 * CFACT 
!  Reaction Label ROCOXY6c        
             RKI( NCELL,  515) =   4.5000D-11 * CFACT 
!  Reaction Label ROCOXY7c        
             RKI( NCELL,  516) =   5.1700D-11 * CFACT 
!  Reaction Label ROCOXY8c        
             RKI( NCELL,  517) =   4.7300D-11 * CFACT 
!  Reaction Label ROCOXY9c        
             RKI( NCELL,  518) =   4.6000D-11 * CFACT 
!  Reaction Label ROCOXY10c       
             RKI( NCELL,  519) =   3.8000D-11 * CFACT 
!  Reaction Label ROCOXY11c       
             RKI( NCELL,  520) =   3.9300D-11 * CFACT 
!  Reaction Label ROCOXY12c       
             RKI( NCELL,  521) =   3.5200D-11 * CFACT 
!  Reaction Label ROCOXY13c       
             RKI( NCELL,  522) =   3.1200D-11 * CFACT 
!  Reaction Label ROCOXY14c       
             RKI( NCELL,  523) =   2.4000D-11 * CFACT 
!  Reaction Label ROCOXY15c       
             RKI( NCELL,  524) =   2.0500D-11 * CFACT 
!  Reaction Label ROCOXY16c       
             RKI( NCELL,  525) =   4.6900D-11 * CFACT 
!  Reaction Label R364            
             RKI( NCELL,  526) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.4500D-12,  -1.7750D+03 )
!  Reaction Label TRP58           
             RKI( NCELL,  527) =   9.2600D-05 * SFACT 
!  Reaction Label TRP59           
             RKI( NCELL,  528) =   9.2600D-05 * SFACT 
!  Reaction Label ROCARO71        
             RKI( NCELL,  529) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.0200D-11,   5.3200D+02 )
!  Reaction Label ROCARO71a       
             RKI( NCELL,  530) =   1.4000D-17 * CFACT 
!  Reaction Label ROCARO71b       
             RKI( NCELL,  531) =   1.5100D-13 * CFACT 
!  Reaction Label ROCARO72        
             RKI( NCELL,  532) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-12,   1.3000D+03 )
!  Reaction Label ROCARO73        
             RKI( NCELL,  533) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label ROCARO74        
             RKI( NCELL,  534) =   2.3000D-12 * CFACT 
!  Reaction Label ROCARO75        
             RKI( NCELL,  535) =   2.5000D-13 * CFACT 
!  Reaction Label ROCARO76        
             RKI( NCELL,  536) =   2.5000D-13 * CFACT 
!  Reaction Label HET_ANO3I       
             RKI( NCELL,  537) =  BLKHET(  NCELL, IK_HETERO_ANO3 )
!  Reaction Label HET_ANO3J       
             RKI( NCELL,  538) =  BLKHET(  NCELL, IK_HETERO_ANO3 )
!  Reaction Label CLT01           
             RKI( NCELL,  548) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.3000D-11,  -2.0000D+02 )
!  Reaction Label CLT02           
             RKI( NCELL,  549) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.0500D-11,  -2.2700D+03 )
!  Reaction Label CLT03           
             RKI( NCELL,  550) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.6000D-11,  -3.7500D+02 )
!  Reaction Label CLT04           
             RKI( NCELL,  551) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-11,   2.7000D+02 )
!  Reaction Label CLT05           
             RKI( NCELL,  552) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.1000D-11,  -9.8000D+02 )
!  Reaction Label CLT06           
             RKI( NCELL,  553) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2000D-11,   0.0000D+00 )
!  Reaction Label CLT07           
             RKI( NCELL,  554) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.3000D-10,   0.0000D+00 )
!  Reaction Label CLT08           
             RKI( NCELL,  555) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-11,   1.6000D+02 )
!  Reaction Label CLT09           
             RKI( NCELL,  556) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.6000D-11,   6.5000D+01 )
!  Reaction Label CLT10           
             RKI( NCELL,  557) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-12,  -1.3000D+02 )
!  Reaction Label CLT11           
             RKI( NCELL,  558) =  CFACT_SQU * POWER_T02( TEMPOT300,   7.7000D-32,  -1.8000D+00 )
!  Reaction Label CLT12           
             RKI( NCELL,  559) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 1.8000D-31,   0.0000D+00,  -2.0000D+00,  & 
     &                                                 1.0000D-10,   0.0000D+00,  -1.0000D+00,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label CLT14           
             RKI( NCELL,  560) =   2.4000D-11 * CFACT 
!  Reaction Label CLT15           
             RKI( NCELL,  561) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.8000D-11,   1.0000D+02 )
!  Reaction Label CLT17           
             RKI( NCELL,  562) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.2000D-12,   1.4500D+02 )
!  Reaction Label CLT22           
             RKI( NCELL,  563) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6000D-12,   2.9000D+02 )
!  Reaction Label CLT23           
             RKI( NCELL,  564) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.4000D-12,   2.9000D+02 )
...
!  Reaction Label CLT27           
             RKI( NCELL,  566) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.0000D-12,  -1.5900D+03 )
!  Reaction Label CLT28           
             RKI( NCELL,  567) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5000D-13,  -1.3700D+03 )
!  Reaction Label CLT31           
             RKI( NCELL,  568) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 1.9000D-32,   0.0000D+00,  -3.6000D+00,  & 
     &                                                 3.7000D-12,   0.0000D+00,  -1.6000D+00,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label CLT32           
             RKI( NCELL,  569) =  RFACT * RKI( NCELL,  568 ) & 
     &                         * (  4.6296D+26 * DEXP( -8.5370D+03 * INV_TEMP) ) 
!  Reaction Label CLT35           
             RKI( NCELL,  570) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.1000D-13,   3.5000D+02 )
!  Reaction Label CLT36           
             RKI( NCELL,  571) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6000D-12,  -1.1000D+03 )
!  Reaction Label CLT37           
             RKI( NCELL,  572) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.0000D-13,   2.3000D+02 )
!  Reaction Label CLT38           
             RKI( NCELL,  573) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-12,   2.7000D+02 )
!  Reaction Label CLT39           
             RKI( NCELL,  574) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8000D-12,  -2.5000D+02 )
!  Reaction Label CLT40           
             RKI( NCELL,  575) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.0000D-12,  -5.0000D+02 )
!  Reaction Label CLT41           
             RKI( NCELL,  576) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.4000D-12,  -1.2500D+03 )
!  Reaction Label CLT43           
             RKI( NCELL,  577) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2000D-12,  -3.3000D+02 )
!  Reaction Label CLT44           
             RKI( NCELL,  578) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-12,   6.0000D+02 )
!  Reaction Label CLT45           
             RKI( NCELL,  579) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.0000D-13,   6.7000D+02 )
!  Reaction Label CLTO01          
             RKI( NCELL,  580) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.1000D-12,  -1.2700D+03 )
!  Reaction Label CLTO02          
             RKI( NCELL,  581) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.2000D-11,  -7.0000D+01 )
!  Reaction Label CLTO03          
             RKI( NCELL,  582) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-10,   0.0000D+00 )
!  Reaction Label CLTO04          
             RKI( NCELL,  583) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-10,   0.0000D+00 )
!  Reaction Label CLTO05          
             RKI( NCELL,  584) =   5.2700D-10 * CFACT 
!  Reaction Label CLOR01          
             RKI( NCELL,  585) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.2500D-12,  -1.1400D+02 )
!  Reaction Label CLOR02          
             RKI( NCELL,  586) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.2500D-12,  -1.1400D+02 )
!  Reaction Label CLOR03          
             RKI( NCELL,  587) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.2500D-12,  -1.1400D+02 )
!  Reaction Label CLOR04          
             RKI( NCELL,  588) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.2500D-12,  -1.1400D+02 )
!  Reaction Label CLOR51          
             RKI( NCELL,  589) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.2500D-12,  -1.1400D+02 )
!  Reaction Label HET_N2O5IJ      
             RKI( NCELL,  590) =  BLKHET(  NCELL, IK_HETERO_N2O5IJ )
!  Reaction Label HET_N2O5K       
             RKI( NCELL,  591) =  BLKHET(  NCELL, IK_HETERO_N2O5K )
!  Reaction Label HET_H2NO3PIJA   
             RKI( NCELL,  592) =  BLKHET(  NCELL, IK_HETERO_H2NO3PAIJ )
!  Reaction Label HET_H2NO3PKA    
             RKI( NCELL,  593) =  BLKHET(  NCELL, IK_HETERO_H2NO3PAK )
!  Reaction Label HET_H2NO3PIB    
             RKI( NCELL,  594) =  BLKHET(  NCELL, IK_HETERO_H2NO3PBIJ )
!  Reaction Label HET_H2NO3PJB    
             RKI( NCELL,  595) =  BLKHET(  NCELL, IK_HETERO_H2NO3PBIJ )
!  Reaction Label HET_H2NO3PKB    
             RKI( NCELL,  596) =  BLKHET(  NCELL, IK_HETERO_H2NO3PBK )
!  Reaction Label HET_CLN3_WAI    
             RKI( NCELL,  597) =  BLKHET(  NCELL, IK_HETERO_CLN3_WAI )
!  Reaction Label HET_CLN3_WAJ    
             RKI( NCELL,  598) =  BLKHET(  NCELL, IK_HETERO_CLN3_WAJ )
!  Reaction Label HET_CLN3_ACLJ   
             RKI( NCELL,  599) =  BLKHET(  NCELL, IK_HETERO_CLN3_ACLJ )
!  Reaction Label HET_SO2_H2O2    
             RKI( NCELL,  600) =  BLKHET(  NCELL, IK_HETERO_SO2H )
!  Reaction Label HET_SO2_O3      
             RKI( NCELL,  601) =  BLKHET(  NCELL, IK_HETERO_SO2O )
!  Reaction Label HET_SO2_MEPX    
             RKI( NCELL,  602) =  BLKHET(  NCELL, IK_HETERO_SO2M )
!  Reaction Label HET_SO2_PACD    
             RKI( NCELL,  603) =  BLKHET(  NCELL, IK_HETERO_SO2P )
!  Reaction Label HET_SO2_NO2     
             RKI( NCELL,  604) =  BLKHET(  NCELL, IK_HETERO_SO2N )
!  Reaction Label HET_SO2_TMI     
             RKI( NCELL,  605) =  BLKHET(  NCELL, IK_HETERO_SO2T )
!  Reaction Label HET_SO2_HCHO    
             RKI( NCELL,  606) =  BLKHET(  NCELL, IK_HETERO_HMSP )
!  Reaction Label HET_SO2_HNO4    
             RKI( NCELL,  607) =  BLKHET(  NCELL, IK_HETERO_HNO4 )
!  Reaction Label HET_HMS_L1      
             RKI( NCELL,  608) =  BLKHET(  NCELL, IK_HETERO_HMSL1 )
!  Reaction Label HET_HMS_L2      
             RKI( NCELL,  609) =  BLKHET(  NCELL, IK_HETERO_HMSL2 )
