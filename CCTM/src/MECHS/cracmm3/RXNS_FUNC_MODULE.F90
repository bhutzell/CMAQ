...
!  Reaction Label T20             
                RKI( NCELL,  405) =  RJBLK( NCELL, IJ_ACRO_09 )
!  Reaction Label CLP01           
                RKI( NCELL,  544) =  RJBLK( NCELL, IJ_CL2_JPL19 )
!  Reaction Label CLP02           
                RKI( NCELL,  545) =  RJBLK( NCELL, IJ_CLO_JPL19 )
!  Reaction Label CLP03           
                RKI( NCELL,  546) =  RJBLK( NCELL, IJ_OCLO_JPL19 )
!  Reaction Label CLP07           
                RKI( NCELL,  547) =  RJBLK( NCELL, IJ_CL2O2_JPL19 )
!  Reaction Label CLP10           
                RKI( NCELL,  548) =  RJBLK( NCELL, IJ_HOCL_JPL19 )
!  Reaction Label CLP12           
                RKI( NCELL,  549) =  RJBLK( NCELL, IJ_CLNO_JPL19 )
!  Reaction Label CLP14           
                RKI( NCELL,  550) =  RJBLK( NCELL, IJ_CLNO2_JPL19 )
!  Reaction Label CLP17           
                RKI( NCELL,  551) =  RJBLK( NCELL, IJ_CLNO3_R_JPL19 )
!  Reaction Label CLP18           
                RKI( NCELL,  552) =  RJBLK( NCELL, IJ_CLNO3_M_JPL19 )

                IF ( SEAWATER (NCELL) .GT. 0.001D0 ) THEN
!  Reaction Label HAL_Ozone       
                   RKI( NCELL,  435) = SEAWATER (NCELL) *  SFACT * HALOGEN_FALLOFF( BLKPRES( NCELL ),   1.0650D-12,   1.3906D+01,  & 
...
!  Reaction Label RBAL1           
             RKI( NCELL,  175) =   2.4000D-15 * CFACT 
!  Reaction Label R155            
             RKI( NCELL,  176) =   3.7800D-12 * CFACT 
!  Reaction Label R156            
             RKI( NCELL,  177) =   1.0600D-12 * CFACT 
!  Reaction Label R158            
             RKI( NCELL,  178) =   2.0100D-10 * CFACT 
!  Reaction Label R159            
             RKI( NCELL,  179) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.2000D-14,  -5.0000D+02 )
...
!  Reaction Label TRP11           
             RKI( NCELL,  181) =   2.9000D-02 * SFACT 
!  Reaction Label TRP12           
             RKI( NCELL,  182) =   2.4000D-02 * SFACT 
!  Reaction Label R166            
...
!  Reaction Label R168            
             RKI( NCELL,  185) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 9.7000D-29,   0.0000D+00,  -5.6000D+00,  & 
     &                                                 9.3000D-12,   0.0000D+00,  -1.5000D+00,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label R169            
             RKI( NCELL,  186) =  RFACT * RKI( NCELL,  185 ) & 
     &                         * (  1.1111D+28 * DEXP( -1.4000D+04 * INV_TEMP) ) 
!  Reaction Label R170            
             RKI( NCELL,  187) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8000D-12,   1.8100D+02 )
!  Reaction Label R171            
             RKI( NCELL,  188) =  SFACT * ARRHENUIS_T03( INV_TEMP,  1.6000D+16,  -1.3486D+04 )
!  Reaction Label R172            
             RKI( NCELL,  189) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8000D-12,   3.0000D+02 )
!  Reaction Label R173            
             RKI( NCELL,  190) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6000D-12,   3.6500D+02 )
!  Reaction Label R174            
...
!  Reaction Label R192            
             RKI( NCELL,  211) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.1000D-12,   2.7000D+02 )
!  Reaction Label R193            
             RKI( NCELL,  212) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9000D-12,   3.0000D+02 )
!  Reaction Label R194            
...
!  Reaction Label R199            
             RKI( NCELL,  218) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.5400D-12,   3.6000D+02 )
!  Reaction Label R200            
...
!  Reaction Label R205            
             RKI( NCELL,  224) =   4.0000D-12 * CFACT 
!  Reaction Label R206            
...
!  Reaction Label R210            
             RKI( NCELL,  229) =   2.0000D-11 * CFACT 
!  Reaction Label R211            
             RKI( NCELL,  230) =   2.0800D-12 * CFACT 
!  Reaction Label R212            
             RKI( NCELL,  231) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.1000D-13,   7.5000D+02 )
!  Reaction Label R213            
             RKI( NCELL,  232) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5000D-13,   7.0000D+02 )
!  Reaction Label R214            
...
!  Reaction Label R217            
             RKI( NCELL,  235) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.9000D-13,   1.3000D+03 )
!  Reaction Label R218            
             RKI( NCELL,  236) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6600D-13,   1.3000D+03 )
!  Reaction Label R219            
             RKI( NCELL,  237) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6600D-13,   1.3000D+03 )
...
!  Reaction Label R229            
             RKI( NCELL,  242) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6000D-13,   1.3000D+03 )
!  Reaction Label TRP21           
             RKI( NCELL,  243) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7300D-13,   1.3000D+03 )
!  Reaction Label TRP22           
             RKI( NCELL,  244) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7100D-13,   1.3000D+03 )
!  Reaction Label TRP23           
             RKI( NCELL,  245) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7500D-13,   1.3000D+03 )
!  Reaction Label R230            
             RKI( NCELL,  246) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6000D-13,   1.3000D+03 )
!  Reaction Label TRP24           
             RKI( NCELL,  247) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7300D-13,   1.3000D+03 )
!  Reaction Label TRP25           
             RKI( NCELL,  248) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7100D-13,   1.3000D+03 )
!  Reaction Label TRP26           
             RKI( NCELL,  249) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7500D-13,   1.3000D+03 )
!  Reaction Label TRP27           
             RKI( NCELL,  250) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7100D-13,   1.3000D+03 )
!  Reaction Label TRP28           
             RKI( NCELL,  251) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7300D-13,   1.3000D+03 )
!  Reaction Label R231            
             RKI( NCELL,  252) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.3000D-13,   1.0400D+03 )
!  Reaction Label R232            
             RKI( NCELL,  253) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.3000D-13,   1.0400D+03 )
!  Reaction Label R233            
...
!  Reaction Label R235            
             RKI( NCELL,  256) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.1500D-13,   1.3000D+03 )
!  Reaction Label R236            
             RKI( NCELL,  257) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8200D-13,   1.3000D+03 )
!  Reaction Label R237            
             RKI( NCELL,  258) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8200D-13,   1.3000D+03 )
!  Reaction Label R238            
             RKI( NCELL,  259) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label R239            
             RKI( NCELL,  260) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label RBAL3           
             RKI( NCELL,  261) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.3800D-13,   1.3000D+03 )
!  Reaction Label RBAL4           
             RKI( NCELL,  262) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.1100D-13,   1.3000D+03 )
!  Reaction Label RBAL5           
             RKI( NCELL,  263) =   2.8600D-13 * CFACT 
!  Reaction Label R240            
             RKI( NCELL,  264) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.7500D-13,   9.8000D+02 )
!  Reaction Label R241            
             RKI( NCELL,  265) =   1.0000D-11 * CFACT 
!  Reaction Label R242            
             RKI( NCELL,  266) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.7500D-13,   9.8000D+02 )
!  Reaction Label R243            
             RKI( NCELL,  267) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.1500D-13,   1.3000D+03 )
!  Reaction Label R244            
...
!  Reaction Label R246            
             RKI( NCELL,  270) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.7500D-13,   9.8000D+02 )
!  Reaction Label R247            
             RKI( NCELL,  271) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6600D-13,   1.3000D+03 )
!  Reaction Label R248            
             RKI( NCELL,  272) =  CFACT * ARRHENUIS_T03( INV_TEMP,  9.5000D-14,   3.9000D+02 )
!  Reaction Label R249            
             RKI( NCELL,  273) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.1800D-13,   1.5800D+02 )
!  Reaction Label R250            
             RKI( NCELL,  274) =  CFACT * ARRHENUIS_T03( INV_TEMP,  9.4600D-14,   4.3100D+02 )
!  Reaction Label R251            
             RKI( NCELL,  275) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.0000D-13,   4.6700D+02 )
!  Reaction Label R253            
             RKI( NCELL,  276) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.7100D-13,   7.0800D+02 )
!  Reaction Label R254            
             RKI( NCELL,  277) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4600D-13,   7.0800D+02 )
!  Reaction Label R255            
             RKI( NCELL,  278) =  CFACT * ARRHENUIS_T03( INV_TEMP,  9.1800D-14,   7.0800D+02 )
...
!  Reaction Label R265            
             RKI( NCELL,  284) =   2.0000D-12 * CFACT 
!  Reaction Label TRP29           
             RKI( NCELL,  285) =   1.0000D-10 * CFACT 
!  Reaction Label TRP30           
             RKI( NCELL,  286) =   2.0000D-12 * CFACT 
!  Reaction Label TRP31           
             RKI( NCELL,  287) =   1.0000D-10 * CFACT 
!  Reaction Label R266            
             RKI( NCELL,  288) =   2.0000D-12 * CFACT 
!  Reaction Label TRP32           
             RKI( NCELL,  289) =   1.0000D-10 * CFACT 
!  Reaction Label TRP33           
             RKI( NCELL,  290) =   2.0000D-12 * CFACT 
!  Reaction Label TRP34           
             RKI( NCELL,  291) =   1.0000D-10 * CFACT 
!  Reaction Label R267            
             RKI( NCELL,  292) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0000D-11,   5.0000D+02 )
!  Reaction Label R268            
             RKI( NCELL,  293) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0000D-11,   5.0000D+02 )
!  Reaction Label R269            
             RKI( NCELL,  294) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5000D-13,   5.0000D+02 )
!  Reaction Label R270            
             RKI( NCELL,  295) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.9100D-13,   5.0800D+02 )
!  Reaction Label R271            
             RKI( NCELL,  296) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.9100D-13,   5.0800D+02 )
!  Reaction Label R272            
             RKI( NCELL,  297) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-14,   2.2100D+02 )
!  Reaction Label R273            
             RKI( NCELL,  298) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-14,   2.2100D+02 )
!  Reaction Label R274            
             RKI( NCELL,  299) =   8.3700D-14 * CFACT 
!  Reaction Label R275            
             RKI( NCELL,  300) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-14,   2.2100D+02 )
!  Reaction Label R276            
...
!  Reaction Label R279            
             RKI( NCELL,  304) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label R280            
             RKI( NCELL,  305) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5000D-13,   5.0000D+02 )
!  Reaction Label R281            
             RKI( NCELL,  306) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6000D-13,   7.0800D+02 )
!  Reaction Label R282            
             RKI( NCELL,  307) =  CFACT * ARRHENUIS_T03( INV_TEMP,  9.6800D-14,   7.0800D+02 )
!  Reaction Label R283            
             RKI( NCELL,  308) =   3.5600D-14 * CFACT 
!  Reaction Label R284            
             RKI( NCELL,  309) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.9900D-15,   1.5100D+03 )
!  Reaction Label R285            
             RKI( NCELL,  310) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.0300D-12,   2.1100D+02 )
!  Reaction Label R286            
             RKI( NCELL,  311) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.9000D-13,   4.6000D+02 )
!  Reaction Label R287            
             RKI( NCELL,  312) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.5900D-13,   5.2200D+02 )
!  Reaction Label R289            
             RKI( NCELL,  313) =  CFACT * ARRHENUIS_T03( INV_TEMP,  9.4800D-13,   7.6500D+02 )
!  Reaction Label R290            
             RKI( NCELL,  314) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.1100D-13,   7.6500D+02 )
!  Reaction Label R291            
             RKI( NCELL,  315) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.0900D-13,   7.6500D+02 )
...
!  Reaction Label R300            
             RKI( NCELL,  320) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.4000D-14,   2.2100D+02 )
!  Reaction Label R301            
             RKI( NCELL,  321) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0000D-12,   5.0000D+02 )
!  Reaction Label TRP35           
             RKI( NCELL,  322) =   1.0000D-10 * CFACT 
!  Reaction Label TRP36           
             RKI( NCELL,  323) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0000D-12,   5.0000D+02 )
!  Reaction Label TRP37           
             RKI( NCELL,  324) =   1.0000D-10 * CFACT 
!  Reaction Label R302            
             RKI( NCELL,  325) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0000D-12,   5.0000D+02 )
!  Reaction Label TRP38           
             RKI( NCELL,  326) =   1.0000D-10 * CFACT 
!  Reaction Label TRP39           
             RKI( NCELL,  327) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.0000D-12,   5.0000D+02 )
!  Reaction Label TRP40           
             RKI( NCELL,  328) =   1.0000D-10 * CFACT 
!  Reaction Label R303            
...
!  Reaction Label R309            
             RKI( NCELL,  335) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.4000D-14,   2.2100D+02 )
!  Reaction Label R310            
             RKI( NCELL,  336) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6800D-12,   5.0000D+02 )
!  Reaction Label R311            
             RKI( NCELL,  337) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.6800D-12,   5.0000D+02 )
!  Reaction Label R312            
             RKI( NCELL,  338) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label R313            
             RKI( NCELL,  339) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label R314            
             RKI( NCELL,  340) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.0800D+02 )
!  Reaction Label R315            
             RKI( NCELL,  341) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.0800D+02 )
!  Reaction Label R316            
             RKI( NCELL,  342) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.5100D-13,   5.6500D+02 )
!  Reaction Label R317            
             RKI( NCELL,  343) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.8500D-13,   7.6500D+02 )
!  Reaction Label R318            
             RKI( NCELL,  344) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.3700D-13,   7.6500D+02 )
!  Reaction Label R319            
             RKI( NCELL,  345) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.0800D+02 )
!  Reaction Label R320            
             RKI( NCELL,  346) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-14,   1.5600D+03 )
!  Reaction Label R321            
             RKI( NCELL,  347) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.5000D-12,   5.0000D+02 )
!  Reaction Label R322            
...
!  Reaction Label TRP54           
             RKI( NCELL,  363) =   2.3000D-12 * CFACT 
!  Reaction Label R341            
             RKI( NCELL,  364) =   4.0000D-12 * CFACT 
!  Reaction Label R342            
             RKI( NCELL,  365) =   4.0000D-12 * CFACT 
!  Reaction Label R343            
...
!  Reaction Label R351            
             RKI( NCELL,  374) =   2.5000D-12 * CFACT 
!  Reaction Label R352            
...
!  Reaction Label R358            
             RKI( NCELL,  381) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.0000D-14,   1.0000D+03 )
!  Reaction Label R359            
             RKI( NCELL,  382) =  CFACT * ARRHENUIS_T03( INV_TEMP,  4.2500D-14,   1.0000D+03 )
!  Reaction Label R360            
             RKI( NCELL,  383) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9600D-14,   1.0000D+03 )
!  Reaction Label R361            
             RKI( NCELL,  384) =   1.2000D-12 * CFACT 
!  Reaction Label R362            
             RKI( NCELL,  385) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.5000D-12,   5.0000D+02 )
!  Reaction Label R363            
             RKI( NCELL,  386) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.1300D-17,   2.9500D+03 )
...
!  Reaction Label TRP52           
             RKI( NCELL,  398) =   1.0000D-10 * CFACT 
!  Reaction Label RAM17           
             RKI( NCELL,  399) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.7800D-11,  -4.0000D+02 )
!  Reaction Label R001c           
             RKI( NCELL,  400) =   6.8900D-12 * CFACT 
!  Reaction Label R002c           
             RKI( NCELL,  401) =   6.5500D-14 * CFACT 
!  Reaction Label T17             
             RKI( NCELL,  402) =  CFACT * ARRHENUIS_T03( INV_TEMP,  8.0000D-12,   3.8000D+02 )
!  Reaction Label T18             
             RKI( NCELL,  403) =   2.9000D-19 * CFACT 
!  Reaction Label T19             
             RKI( NCELL,  404) =   3.4000D-15 * CFACT 
!  Reaction Label T10             
             RKI( NCELL,  406) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4800D-11,   4.4800D+02 )
!  Reaction Label T10a            
             RKI( NCELL,  407) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label T10b            
             RKI( NCELL,  408) =   2.3000D-12 * CFACT 
!  Reaction Label T10c            
             RKI( NCELL,  409) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.9300D-13,   1.3000D+03 )
!  Reaction Label T10d            
             RKI( NCELL,  410) =   2.3900D-12 * CFACT 
!  Reaction Label T10e            
             RKI( NCELL,  411) =   1.3700D-11 * CFACT 
!  Reaction Label T11             
             RKI( NCELL,  412) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.3400D-14,  -2.2830D+03 )
!  Reaction Label T12             
             RKI( NCELL,  413) =   1.0000D-13 * CFACT 
!  Reaction Label R003c           
             RKI( NCELL,  414) =   5.0100D-11 * CFACT 
!  Reaction Label R004c           
             RKI( NCELL,  415) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label R005c           
             RKI( NCELL,  416) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.7500D-13,   9.8000D+02 )
!  Reaction Label R006c           
             RKI( NCELL,  417) =   4.4000D-11 * CFACT 
!  Reaction Label R007c           
             RKI( NCELL,  418) =   3.4300D-17 * CFACT 
!  Reaction Label R008c           
             RKI( NCELL,  419) =   8.9900D-12 * CFACT 
!  Reaction Label R010c           
             RKI( NCELL,  420) =   1.2000D-11 * CFACT 
!  Reaction Label R011c           
             RKI( NCELL,  421) =   1.9000D-11 * CFACT 
...
!  Reaction Label R014c           
             RKI( NCELL,  424) =   2.3000D-12 * CFACT 
!  Reaction Label R015c           
             RKI( NCELL,  425) =   1.2000D-14 * CFACT 
!  Reaction Label R016c           
             RKI( NCELL,  426) =   1.9700D-10 * CFACT 
!  Reaction Label R017c           
             RKI( NCELL,  427) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8400D-13,   1.3000D+03 )
...
!  Reaction Label HET_GLY         
             RKI( NCELL,  430) =  BLKHET(  NCELL, IK_HETERO_GLY )
!  Reaction Label HET_MGLY        
             RKI( NCELL,  431) =  BLKHET(  NCELL, IK_HETERO_MGLY )
!  Reaction Label HET_NO2         
             RKI( NCELL,  432) =  BLKHET(  NCELL, IK_HETERO_NO2 )
!  Reaction Label HET_HO2         
             RKI( NCELL,  433) =  BLKHET(  NCELL, IK_HETERO_HO2 )
!  Reaction Label HET_NO3         
             RKI( NCELL,  434) =  BLKHET(  NCELL, IK_HETERO_NO3 )
!  Reaction Label HET_IEPOX       
             RKI( NCELL,  436) =  BLKHET(  NCELL, IK_HETERO_IEPOX )
!  Reaction Label HET_ISO3TET     
             RKI( NCELL,  437) =  BLKHET(  NCELL, IK_HETERO_ISO3NOSJ )
!  Reaction Label HET_IEPOXOS     
             RKI( NCELL,  438) =  BLKHET(  NCELL, IK_HETERO_ISO3OSJ )
!  Reaction Label HET_IPX         
             RKI( NCELL,  439) =   2.0000D+00 * BLKHET( NCELL, IK_HETERO_IEPOX )
!  Reaction Label HET_INALD       
             RKI( NCELL,  440) =   5.0000D-01 * BLKHET( NCELL, IK_HETERO_IEPOX )
!  Reaction Label ROCALK1c        
             RKI( NCELL,  441) =   1.5300D-11 * CFACT 
!  Reaction Label ROCALK2c        
             RKI( NCELL,  442) =   1.6800D-11 * CFACT 
!  Reaction Label ROCALK3c        
             RKI( NCELL,  443) =   2.2400D-11 * CFACT 
!  Reaction Label ROCALK4c        
             RKI( NCELL,  444) =   2.6700D-11 * CFACT 
!  Reaction Label ROCALK5c        
             RKI( NCELL,  445) =   3.0900D-11 * CFACT 
!  Reaction Label ROCALK6c        
             RKI( NCELL,  446) =   3.3800D-11 * CFACT 
!  Reaction Label HC1001          
             RKI( NCELL,  447) =   1.1000D-11 * CFACT 
...
!  Reaction Label ROCALK19c       
             RKI( NCELL,  462) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6800D-13,   1.3000D+03 )
!  Reaction Label ROCALK20c       
             RKI( NCELL,  463) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7100D-13,   1.3000D+03 )
!  Reaction Label ROCALK21c       
             RKI( NCELL,  464) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7800D-13,   1.3000D+03 )
!  Reaction Label ROCALK22c       
             RKI( NCELL,  465) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8000D-13,   1.3000D+03 )
!  Reaction Label ROCALK23c       
             RKI( NCELL,  466) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8100D-13,   1.3000D+03 )
!  Reaction Label ROCALK24c       
             RKI( NCELL,  467) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8100D-13,   1.3000D+03 )
!  Reaction Label HC1004          
             RKI( NCELL,  468) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6600D-13,   1.3000D+03 )
...
!  Reaction Label ROCALK30c       
             RKI( NCELL,  474) =   1.8800D-01 * SFACT 
!  Reaction Label HC1005          
             RKI( NCELL,  475) =   1.8800D-01 * SFACT 
...
!  Reaction Label ROCALK43c       
             RKI( NCELL,  490) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7100D-13,   1.3000D+03 )
!  Reaction Label ROCALK44c       
             RKI( NCELL,  491) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7300D-13,   1.3000D+03 )
!  Reaction Label ROCALK45c       
             RKI( NCELL,  492) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7800D-13,   1.3000D+03 )
!  Reaction Label ROCALK46c       
             RKI( NCELL,  493) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8000D-13,   1.3000D+03 )
!  Reaction Label ROCALK47c       
             RKI( NCELL,  494) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8100D-13,   1.3000D+03 )
!  Reaction Label ROCALK48c       
             RKI( NCELL,  495) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8200D-13,   1.3000D+03 )
!  Reaction Label HC1008          
             RKI( NCELL,  496) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6600D-13,   1.3000D+03 )
...
!  Reaction Label ROCARO11        
             RKI( NCELL,  503) =   1.8100D-11 * CFACT 
...
!  Reaction Label ROCARO21        
             RKI( NCELL,  509) =   2.3100D-11 * CFACT 
!  Reaction Label ROCARO22        
             RKI( NCELL,  510) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label ROCARO23        
             RKI( NCELL,  511) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label ROCARO24        
             RKI( NCELL,  512) =   2.3000D-12 * CFACT 
!  Reaction Label ROCARO25        
             RKI( NCELL,  513) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label ROCARO26        
             RKI( NCELL,  514) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label ROCOXY1c        
             RKI( NCELL,  515) =   5.9000D-11 * CFACT 
!  Reaction Label ROCOXY2c        
             RKI( NCELL,  516) =   6.0700D-11 * CFACT 
!  Reaction Label ROCOXY3c        
             RKI( NCELL,  517) =   5.5400D-11 * CFACT 
!  Reaction Label ROCOXY4c        
             RKI( NCELL,  518) =   5.6300D-11 * CFACT 
!  Reaction Label ROCOXY5c        
             RKI( NCELL,  519) =   5.4600D-11 * CFACT 
!  Reaction Label ROCOXY6c        
             RKI( NCELL,  520) =   4.5000D-11 * CFACT 
!  Reaction Label ROCOXY7c        
             RKI( NCELL,  521) =   5.1700D-11 * CFACT 
!  Reaction Label ROCOXY8c        
             RKI( NCELL,  522) =   4.7300D-11 * CFACT 
!  Reaction Label ROCOXY9c        
             RKI( NCELL,  523) =   4.6000D-11 * CFACT 
!  Reaction Label ROCOXY10c       
             RKI( NCELL,  524) =   3.8000D-11 * CFACT 
!  Reaction Label ROCOXY11c       
             RKI( NCELL,  525) =   3.9300D-11 * CFACT 
!  Reaction Label ROCOXY12c       
             RKI( NCELL,  526) =   3.5200D-11 * CFACT 
!  Reaction Label ROCOXY13c       
             RKI( NCELL,  527) =   3.1200D-11 * CFACT 
!  Reaction Label ROCOXY14c       
             RKI( NCELL,  528) =   2.4000D-11 * CFACT 
!  Reaction Label ROCOXY15c       
             RKI( NCELL,  529) =   2.0500D-11 * CFACT 
!  Reaction Label ROCOXY16c       
             RKI( NCELL,  530) =   4.6900D-11 * CFACT 
!  Reaction Label R364            
             RKI( NCELL,  531) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.4500D-12,  -1.7750D+03 )
!  Reaction Label TRP58           
             RKI( NCELL,  532) =   9.2600D-05 * SFACT 
!  Reaction Label TRP59           
             RKI( NCELL,  533) =   9.2600D-05 * SFACT 
!  Reaction Label ROCARO71        
             RKI( NCELL,  534) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.0200D-11,   5.3200D+02 )
!  Reaction Label ROCARO71a       
             RKI( NCELL,  535) =   1.4000D-17 * CFACT 
!  Reaction Label ROCARO71b       
             RKI( NCELL,  536) =   1.5100D-13 * CFACT 
!  Reaction Label ROCARO72        
             RKI( NCELL,  537) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-12,   1.3000D+03 )
!  Reaction Label ROCARO73        
             RKI( NCELL,  538) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label ROCARO74        
             RKI( NCELL,  539) =   2.3000D-12 * CFACT 
!  Reaction Label ROCARO75        
             RKI( NCELL,  540) =   2.5000D-13 * CFACT 
!  Reaction Label ROCARO76        
             RKI( NCELL,  541) =   2.5000D-13 * CFACT 
!  Reaction Label HET_ANO3I       
             RKI( NCELL,  542) =  BLKHET(  NCELL, IK_HETERO_ANO3 )
!  Reaction Label HET_ANO3J       
             RKI( NCELL,  543) =  BLKHET(  NCELL, IK_HETERO_ANO3 )
...
!  Reaction Label CLOR01          
             RKI( NCELL,  590) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.2500D-12,  -1.1400D+02 )
!  Reaction Label CLOR02          
             RKI( NCELL,  591) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.2500D-12,  -1.1400D+02 )
!  Reaction Label CLOR03          
             RKI( NCELL,  592) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.2500D-12,  -1.1400D+02 )
!  Reaction Label CLOR04          
             RKI( NCELL,  593) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.2500D-12,  -1.1400D+02 )
!  Reaction Label CLOR51          
             RKI( NCELL,  594) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.2500D-12,  -1.1400D+02 )
!  Reaction Label HET_N2O5IJ      
             RKI( NCELL,  595) =  BLKHET(  NCELL, IK_HETERO_N2O5IJ )
!  Reaction Label HET_N2O5K       
             RKI( NCELL,  596) =  BLKHET(  NCELL, IK_HETERO_N2O5K )
!  Reaction Label HET_H2NO3PIJA   
             RKI( NCELL,  597) =  BLKHET(  NCELL, IK_HETERO_H2NO3PAIJ )
!  Reaction Label HET_H2NO3PKA    
             RKI( NCELL,  598) =  BLKHET(  NCELL, IK_HETERO_H2NO3PAK )
!  Reaction Label HET_H2NO3PIB    
             RKI( NCELL,  599) =  BLKHET(  NCELL, IK_HETERO_H2NO3PBIJ )
!  Reaction Label HET_H2NO3PJB    
             RKI( NCELL,  600) =  BLKHET(  NCELL, IK_HETERO_H2NO3PBIJ )
!  Reaction Label HET_H2NO3PKB    
             RKI( NCELL,  601) =  BLKHET(  NCELL, IK_HETERO_H2NO3PBK )
!  Reaction Label HET_CLN3_WAI    
             RKI( NCELL,  602) =  BLKHET(  NCELL, IK_HETERO_CLN3_WAI )
!  Reaction Label HET_CLN3_WAJ    
             RKI( NCELL,  603) =  BLKHET(  NCELL, IK_HETERO_CLN3_WAJ )
!  Reaction Label HET_CLN3_ACLJ   
             RKI( NCELL,  604) =  BLKHET(  NCELL, IK_HETERO_CLN3_ACLJ )
