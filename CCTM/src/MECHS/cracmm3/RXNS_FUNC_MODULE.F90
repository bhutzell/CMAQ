...
!  Reaction Label HAL_Ozone       
                   RKI( NCELL,  434) = SEAWATER (NCELL) *  SFACT * HALOGEN_FALLOFF( BLKPRES( NCELL ),   1.0650D-12,   1.3906D+01,  & 
...
!  Reaction Label HET_IEPOX       
             RKI( NCELL,  435) =  BLKHET(  NCELL, IK_HETERO_IEPOX )
!  Reaction Label HET_ISO3TET     
             RKI( NCELL,  436) =  BLKHET(  NCELL, IK_HETERO_ISO3NOSJ )
!  Reaction Label HET_IEPOXOS     
             RKI( NCELL,  437) =  BLKHET(  NCELL, IK_HETERO_ISO3OSJ )
!  Reaction Label HET_IPX         
             RKI( NCELL,  438) =   2.0000D+00 * BLKHET( NCELL, IK_HETERO_IEPOX )
!  Reaction Label HET_INALD       
             RKI( NCELL,  439) =   5.0000D-01 * BLKHET( NCELL, IK_HETERO_IEPOX )
!  Reaction Label ROCALK1c        
             RKI( NCELL,  440) =   1.5300D-11 * CFACT 
!  Reaction Label ROCALK2c        
             RKI( NCELL,  441) =   1.6800D-11 * CFACT 
!  Reaction Label ROCALK3c        
             RKI( NCELL,  442) =   2.2400D-11 * CFACT 
!  Reaction Label ROCALK4c        
             RKI( NCELL,  443) =   2.6700D-11 * CFACT 
!  Reaction Label ROCALK5c        
             RKI( NCELL,  444) =   3.0900D-11 * CFACT 
!  Reaction Label ROCALK6c        
             RKI( NCELL,  445) =   3.3800D-11 * CFACT 
!  Reaction Label HC1001          
             RKI( NCELL,  446) =   1.1000D-11 * CFACT 
...
!  Reaction Label ROCALK19c       
             RKI( NCELL,  461) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6800D-13,   1.3000D+03 )
!  Reaction Label ROCALK20c       
             RKI( NCELL,  462) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7100D-13,   1.3000D+03 )
!  Reaction Label ROCALK21c       
             RKI( NCELL,  463) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7800D-13,   1.3000D+03 )
!  Reaction Label ROCALK22c       
             RKI( NCELL,  464) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8000D-13,   1.3000D+03 )
...
!  Reaction Label ROCALK43c       
             RKI( NCELL,  489) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7100D-13,   1.3000D+03 )
!  Reaction Label ROCALK44c       
             RKI( NCELL,  490) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7300D-13,   1.3000D+03 )
!  Reaction Label ROCALK45c       
             RKI( NCELL,  491) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7800D-13,   1.3000D+03 )
!  Reaction Label ROCALK46c       
             RKI( NCELL,  492) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8000D-13,   1.3000D+03 )
!  Reaction Label ROCALK47c       
             RKI( NCELL,  493) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8100D-13,   1.3000D+03 )
!  Reaction Label ROCALK48c       
             RKI( NCELL,  494) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.8200D-13,   1.3000D+03 )
!  Reaction Label HC1008          
             RKI( NCELL,  495) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6600D-13,   1.3000D+03 )
!  Reaction Label ROCARO01        
             RKI( NCELL,  496) =   1.8100D-11 * CFACT 
...
!  Reaction Label ROCARO11        
             RKI( NCELL,  502) =   1.8100D-11 * CFACT 
!  Reaction Label ROCARO12        
             RKI( NCELL,  503) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label ROCARO13        
             RKI( NCELL,  504) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label ROCARO14        
             RKI( NCELL,  505) =   2.3000D-12 * CFACT 
!  Reaction Label ROCARO15        
             RKI( NCELL,  506) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label ROCARO16        
             RKI( NCELL,  507) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label ROCARO21        
             RKI( NCELL,  508) =   2.3100D-11 * CFACT 
!  Reaction Label ROCARO22        
             RKI( NCELL,  509) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-13,   1.3000D+03 )
!  Reaction Label ROCARO23        
             RKI( NCELL,  510) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label ROCARO24        
             RKI( NCELL,  511) =   2.3000D-12 * CFACT 
!  Reaction Label ROCARO25        
             RKI( NCELL,  512) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5600D-14,   7.0800D+02 )
!  Reaction Label ROCARO26        
             RKI( NCELL,  513) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-13,   7.6500D+02 )
!  Reaction Label ROCOXY1c        
             RKI( NCELL,  514) =   5.9000D-11 * CFACT 
!  Reaction Label ROCOXY2c        
             RKI( NCELL,  515) =   6.0700D-11 * CFACT 
!  Reaction Label ROCOXY3c        
             RKI( NCELL,  516) =   5.5400D-11 * CFACT 
!  Reaction Label ROCOXY4c        
             RKI( NCELL,  517) =   5.6300D-11 * CFACT 
!  Reaction Label ROCOXY5c        
             RKI( NCELL,  518) =   5.4600D-11 * CFACT 
!  Reaction Label ROCOXY6c        
             RKI( NCELL,  519) =   4.5000D-11 * CFACT 
!  Reaction Label ROCOXY7c        
             RKI( NCELL,  520) =   5.1700D-11 * CFACT 
!  Reaction Label ROCOXY8c        
             RKI( NCELL,  521) =   4.7300D-11 * CFACT 
!  Reaction Label ROCOXY9c        
             RKI( NCELL,  522) =   4.6000D-11 * CFACT 
!  Reaction Label ROCOXY10c       
             RKI( NCELL,  523) =   3.8000D-11 * CFACT 
!  Reaction Label ROCOXY11c       
             RKI( NCELL,  524) =   3.9300D-11 * CFACT 
!  Reaction Label ROCOXY12c       
             RKI( NCELL,  525) =   3.5200D-11 * CFACT 
!  Reaction Label ROCOXY13c       
             RKI( NCELL,  526) =   3.1200D-11 * CFACT 
!  Reaction Label ROCOXY14c       
             RKI( NCELL,  527) =   2.4000D-11 * CFACT 
...
!  Reaction Label ROCARO71        
             RKI( NCELL,  533) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.0200D-11,   5.3200D+02 )
!  Reaction Label ROCARO71a       
             RKI( NCELL,  534) =   1.4000D-17 * CFACT 
!  Reaction Label ROCARO71b       
             RKI( NCELL,  535) =   1.5100D-13 * CFACT 
!  Reaction Label ROCARO72        
             RKI( NCELL,  536) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.9100D-12,   1.3000D+03 )
!  Reaction Label ROCARO73        
             RKI( NCELL,  537) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-12,   3.6000D+02 )
!  Reaction Label ROCARO74        
             RKI( NCELL,  538) =   2.3000D-12 * CFACT 
...
!  Reaction Label CLT01           
             RKI( NCELL,  552) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.3000D-11,  -2.0000D+02 )
!  Reaction Label CLT02           
             RKI( NCELL,  553) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.0500D-11,  -2.2700D+03 )
!  Reaction Label CLT03           
             RKI( NCELL,  554) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.6000D-11,  -3.7500D+02 )
!  Reaction Label CLT04           
             RKI( NCELL,  555) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-11,   2.7000D+02 )
!  Reaction Label CLT05           
             RKI( NCELL,  556) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.1000D-11,  -9.8000D+02 )
!  Reaction Label CLT06           
             RKI( NCELL,  557) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2000D-11,   0.0000D+00 )
!  Reaction Label CLT07           
             RKI( NCELL,  558) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.3000D-10,   0.0000D+00 )
!  Reaction Label CLT08           
             RKI( NCELL,  559) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-11,   1.6000D+02 )
!  Reaction Label CLT09           
             RKI( NCELL,  560) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.6000D-11,   6.5000D+01 )
!  Reaction Label CLT10           
             RKI( NCELL,  561) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.4000D-12,  -1.3000D+02 )
!  Reaction Label CLT11           
             RKI( NCELL,  562) =  CFACT_SQU * POWER_T02( TEMPOT300,   7.7000D-32,  -1.8000D+00 )
...
!  Reaction Label CLT15           
             RKI( NCELL,  565) =  CFACT * ARRHENUIS_T03( INV_TEMP,  5.8000D-11,   1.0000D+02 )
!  Reaction Label CLT17           
             RKI( NCELL,  566) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.2000D-12,   1.4500D+02 )
!  Reaction Label CLT22           
             RKI( NCELL,  567) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6000D-12,   2.9000D+02 )
!  Reaction Label CLT23           
             RKI( NCELL,  568) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.4000D-12,   2.9000D+02 )
!  Reaction Label CLT25           
             RKI( NCELL,  569) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 1.8000D-31,   0.0000D+00,  -3.4000D+00,  & 
     &                                                 1.5000D-11,   0.0000D+00,  -1.9000D+00,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label CLT27           
             RKI( NCELL,  570) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.0000D-12,  -1.5900D+03 )
!  Reaction Label CLT28           
             RKI( NCELL,  571) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.5000D-13,  -1.3700D+03 )
!  Reaction Label CLT31           
             RKI( NCELL,  572) =  CFACT * FALLOFF_T10( INV_TEMP,  TEMPOT300,  CAIR, & 
     &                                                 1.9000D-32,   0.0000D+00,  -3.6000D+00,  & 
     &                                                 3.7000D-12,   0.0000D+00,  -1.6000D+00,  & 
     &                                                 1.0000D+00,   6.0000D-01 )
!  Reaction Label CLT32           
             RKI( NCELL,  573) =  RFACT * RKI( NCELL,  572 ) & 
     &                         * (  4.6296D+26 * DEXP( -8.5370D+03 * INV_TEMP) ) 
!  Reaction Label CLT35           
             RKI( NCELL,  574) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.1000D-13,   3.5000D+02 )
!  Reaction Label CLT36           
             RKI( NCELL,  575) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.6000D-12,  -1.1000D+03 )
!  Reaction Label CLT37           
             RKI( NCELL,  576) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.0000D-13,   2.3000D+02 )
!  Reaction Label CLT38           
             RKI( NCELL,  577) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.4000D-12,   2.7000D+02 )
!  Reaction Label CLT39           
             RKI( NCELL,  578) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.8000D-12,  -2.5000D+02 )
!  Reaction Label CLT40           
             RKI( NCELL,  579) =  CFACT * ARRHENUIS_T03( INV_TEMP,  3.0000D-12,  -5.0000D+02 )
!  Reaction Label CLT41           
             RKI( NCELL,  580) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.4000D-12,  -1.2500D+03 )
!  Reaction Label CLT43           
             RKI( NCELL,  581) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.2000D-12,  -3.3000D+02 )
!  Reaction Label CLT44           
             RKI( NCELL,  582) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-12,   6.0000D+02 )
!  Reaction Label CLT45           
             RKI( NCELL,  583) =  CFACT * ARRHENUIS_T03( INV_TEMP,  6.0000D-13,   6.7000D+02 )
!  Reaction Label CLTO01          
             RKI( NCELL,  584) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.1000D-12,  -1.2700D+03 )
!  Reaction Label CLTO02          
             RKI( NCELL,  585) =  CFACT * ARRHENUIS_T03( INV_TEMP,  7.2000D-11,  -7.0000D+01 )
!  Reaction Label CLTO03          
             RKI( NCELL,  586) =  CFACT * ARRHENUIS_T03( INV_TEMP,  1.4000D-10,   0.0000D+00 )
!  Reaction Label CLTO04          
             RKI( NCELL,  587) =  CFACT * ARRHENUIS_T03( INV_TEMP,  2.7000D-10,   0.0000D+00 )
!  Reaction Label CLTO05          
             RKI( NCELL,  588) =   5.2700D-10 * CFACT 
...
!  Reaction Label HET_N2O5IJ      
             RKI( NCELL,  594) =  BLKHET(  NCELL, IK_HETERO_N2O5IJ )
!  Reaction Label HET_N2O5K       
             RKI( NCELL,  595) =  BLKHET(  NCELL, IK_HETERO_N2O5K )
!  Reaction Label HET_H2NO3PIJA   
             RKI( NCELL,  596) =  BLKHET(  NCELL, IK_HETERO_H2NO3PAIJ )
!  Reaction Label HET_H2NO3PKA    
             RKI( NCELL,  597) =  BLKHET(  NCELL, IK_HETERO_H2NO3PAK )
!  Reaction Label HET_H2NO3PIB    
             RKI( NCELL,  598) =  BLKHET(  NCELL, IK_HETERO_H2NO3PBIJ )
!  Reaction Label HET_H2NO3PJB    
             RKI( NCELL,  599) =  BLKHET(  NCELL, IK_HETERO_H2NO3PBIJ )
!  Reaction Label HET_H2NO3PKB    
             RKI( NCELL,  600) =  BLKHET(  NCELL, IK_HETERO_H2NO3PBK )
!  Reaction Label HET_CLN3_WAI    
             RKI( NCELL,  601) =  BLKHET(  NCELL, IK_HETERO_CLN3_WAI )
!  Reaction Label HET_CLN3_WAJ    
             RKI( NCELL,  602) =  BLKHET(  NCELL, IK_HETERO_CLN3_WAJ )
!  Reaction Label HET_CLN3_ACLJ   
             RKI( NCELL,  603) =  BLKHET(  NCELL, IK_HETERO_CLN3_ACLJ )
!  Reaction Label HET_SO2_H2O2    
             RKI( NCELL,  605) =  BLKHET(  NCELL, IK_HETERO_SO2H )
!  Reaction Label HET_SO2_O3      
             RKI( NCELL,  606) =  BLKHET(  NCELL, IK_HETERO_SO2O )
!  Reaction Label HET_SO2_MEPX    
             RKI( NCELL,  607) =  BLKHET(  NCELL, IK_HETERO_SO2M )
!  Reaction Label HET_SO2_PACD    
             RKI( NCELL,  608) =  BLKHET(  NCELL, IK_HETERO_SO2P )
!  Reaction Label HET_SO2_NO2     
             RKI( NCELL,  609) =  BLKHET(  NCELL, IK_HETERO_SO2N )
!  Reaction Label HET_SO2_TMI     
             RKI( NCELL,  610) =  BLKHET(  NCELL, IK_HETERO_SO2T )
!  Reaction Label HET_SO2_HCHO    
             RKI( NCELL,  611) =  BLKHET(  NCELL, IK_HETERO_HMSP )
!  Reaction Label HET_SO2_HNO4    
             RKI( NCELL,  612) =  BLKHET(  NCELL, IK_HETERO_HNO4 )
!  Reaction Label HET_HMS_L1      
             RKI( NCELL,  613) =  BLKHET(  NCELL, IK_HETERO_HMSL1 )
!  Reaction Label HET_HMS_L2      
             RKI( NCELL,  614) =  BLKHET(  NCELL, IK_HETERO_HMSL2 )
