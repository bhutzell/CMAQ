...
!  Reaction Label HET_ANO3I       
             RKI( NCELL,  350) =  BLKHET(  NCELL, IK_HETERO_ANO3 )
!  Reaction Label HET_ANO3J       
             RKI( NCELL,  351) =  BLKHET(  NCELL, IK_HETERO_ANO3 )
!  Reaction Label HET_SO2_H2O2    
             RKI( NCELL,  352) =  BLKHET(  NCELL, IK_HETERO_SO2H )
!  Reaction Label HET_SO2_O3      
             RKI( NCELL,  353) =  BLKHET(  NCELL, IK_HETERO_SO2O )
!  Reaction Label HET_SO2_MEPX    
             RKI( NCELL,  354) =  BLKHET(  NCELL, IK_HETERO_SO2M )
!  Reaction Label HET_SO2_PACD    
             RKI( NCELL,  355) =  BLKHET(  NCELL, IK_HETERO_SO2P )
!  Reaction Label HET_SO2_NO2     
             RKI( NCELL,  356) =  BLKHET(  NCELL, IK_HETERO_SO2N )
!  Reaction Label HET_SO2_TMI     
             RKI( NCELL,  357) =  BLKHET(  NCELL, IK_HETERO_SO2T )
!  Reaction Label HET_SO2_HCHO    
             RKI( NCELL,  358) =  BLKHET(  NCELL, IK_HETERO_HMSP )
!  Reaction Label HET_SO2_HNO4    
             RKI( NCELL,  359) =  BLKHET(  NCELL, IK_HETERO_HNO4 )
!  Reaction Label HET_HMS_L1      
             RKI( NCELL,  360) =  BLKHET(  NCELL, IK_HETERO_HMSL1 )
!  Reaction Label HET_HMS_L2      
             RKI( NCELL,  361) =  BLKHET(  NCELL, IK_HETERO_HMSL2 )
