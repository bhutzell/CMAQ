...
!
! Revised:  30 Sep 2022  Original version.  (D. Wong)
!===============================================================================
...
! ?????
!       on the WRF-CMAQ side, coupler_data_retrieving routine will mimic INTERPX to
!       extract the inner portion (without the ghost cells) for MET_CRO_2D and
!       MET_CRO_3D data
