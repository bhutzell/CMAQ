...
# ============== CCTMv6.X STAGE EM CRACMM 12US1 Run Script ================
...
setenv CTM_WB_DUST Y         #> use inline windblown dust emissions [ default: N ]
...
# =====================================================================
  ...
  if( $USE_SAGE_N == 'Y' ) then
     ...
     if( $USE_SAGE_N_EF == 'Y') then
        setenv SAGE_EF ${INPDIR}/surface/BEIS4_SAGE_beld6_norm_emis_12US1.ncf
     endif
  endif
